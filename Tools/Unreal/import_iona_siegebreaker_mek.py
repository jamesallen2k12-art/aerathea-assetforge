...
MATERIAL_PATH = "/Game/Aerathea/Materials/Gnome/Iona"
MATERIAL_INSTANCE_PATH = "/Game/Aerathea/Materials/Instances"
IONA_MEK_TAG = "AET_IONA_SIEGEBREAKER_MEK_REVIEW"
FBX_IMPORT_UNIFORM_SCALE = 0.01


IONA_MEK_ASSET = {
    "name": "SK_GNM_IonaSiegebreakerMek_A01",
    "source": ROOT / "SourceAssets/Exports/Characters/Gnomes/Iona/SK_GNM_IonaSiegebreakerMek_A01/SK_GNM_IonaSiegebreakerMek_A01.fbx",
    "destination": "/Game/Aerathea/Characters/Gnomes/Iona/Mek",
    "physics_asset": "/Game/Aerathea/Characters/Gnomes/Iona/Mek/PHYS_GNM_IonaSiegebreakerMek_A01",
    "anim_blueprint": "/Game/Aerathea/Characters/Gnomes/Iona/Mek/ABP_GNM_IonaSiegebreakerMek_A01",
    "skeleton": "/Game/Aerathea/Characters/Gnomes/Iona/Mek/SK_GNM_IonaSiegebreakerMek_A01_Skeleton",
    "actor_label": "AET_PROD_GNM_IonaSiegebreakerMek_A01",
    "actor_location": unreal.Vector(1260.0, 520.0, 0.0),
    "actor_yaw": -42.0,
}


IONA_MEK_SOCKET_SPECS = [
    ("socket_pilot_harness", "cockpit", unreal.Vector(36.0, 0.0, 14.0), unreal.Rotator(0.0, 0.0, 0.0)),
    ("socket_cannon_l_mount", "cannon_mount_l", unreal.Vector(0.0, 0.0, 0.0), unreal.Rotator(0.0, 0.0, 0.0)),
    ("socket_cannon_r_mount", "cannon_mount_r", unreal.Vector(0.0, 0.0, 0.0), unreal.Rotator(0.0, 0.0, 0.0)),
    ("socket_cannon_l_muzzle", "cannon_mount_l", unreal.Vector(144.0, 18.0, 38.0), unreal.Rotator(0.0, 0.0, 0.0)),
    ("socket_cannon_r_muzzle", "cannon_mount_r", unreal.Vector(144.0, -18.0, 38.0), unreal.Rotator(0.0, 0.0, 0.0)),
    ("socket_core_chest", "core_chest", unreal.Vector(46.0, 0.0, 8.0), unreal.Rotator(0.0, 0.0, 0.0)),
    ("socket_core_back", "core_back", unreal.Vector(-30.0, 0.0, 42.0), unreal.Rotator(0.0, 0.0, 0.0)),
    ("socket_hand_l", "fist_l", unreal.Vector(34.0, 0.0, 8.0), unreal.Rotator(0.0, 0.0, 0.0)),
    ("socket_hand_r", "fist_r", unreal.Vector(34.0, 0.0, 8.0), unreal.Rotator(0.0, 0.0, 0.0)),
    ("socket_foot_l", "foot_l", unreal.Vector(52.0, 0.0, -6.0), unreal.Rotator(0.0, 0.0, 0.0)),
    ("socket_foot_r", "foot_r", unreal.Vector(52.0, 0.0, -6.0), unreal.Rotator(0.0, 0.0, 0.0)),
    ("socket_vent_l", "vent_l", unreal.Vector(0.0, 0.0, 66.0), unreal.Rotator(0.0, 0.0, 0.0)),
    ("socket_vent_r", "vent_r", unreal.Vector(0.0, 0.0, 66.0), unreal.Rotator(0.0, 0.0, 0.0)),
    ("socket_camera_focus", "cockpit", unreal.Vector(74.0, 0.0, 60.0), unreal.Rotator(0.0, 0.0, 0.0)),
    ("vfx_arc_l", "cannon_mount_l", unreal.Vector(144.0, 18.0, 38.0), unreal.Rotator(0.0, 0.0, 0.0)),
    ("vfx_arc_r", "cannon_mount_r", unreal.Vector(144.0, -18.0, 38.0), unreal.Rotator(0.0, 0.0, 0.0)),
]
...
def ensure_materials():
    return {
        "M_GNM_IonaMek_DarkIron_Blockout_A01": color_material(
            "M_GNM_IonaMek_DarkIron_Blockout_A01",
            unreal.LinearColor(0.065, 0.070, 0.075, 1.0),
            roughness=0.68,
            metallic=0.66,
        ),
        "M_GNM_IonaMek_BrassCopper_Blockout_A01": color_material(
            "M_GNM_IonaMek_BrassCopper_Blockout_A01",
            unreal.LinearColor(0.70, 0.43, 0.18, 1.0),
            roughness=0.55,
            metallic=0.78,
        ),
        "M_GNM_IonaMek_LeatherCable_Blockout_A01": color_material(
            "M_GNM_IonaMek_LeatherCable_Blockout_A01",
            unreal.LinearColor(0.16, 0.09, 0.055, 1.0),
        ),
        "M_GNM_IonaMek_AetheriumGlow_Blockout_A01": color_material(
            "M_GNM_IonaMek_AetheriumGlow_Blockout_A01",
            unreal.LinearColor(0.00, 0.55, 1.00, 1.0),
            roughness=0.24,
            emissive=unreal.LinearColor(0.0, 1.25, 3.9, 1.0),
        ),
        "M_GNM_IonaMek_CockpitGlass_Blockout_A01": color_material(
            "M_GNM_IonaMek_CockpitGlass_Blockout_A01",
            unreal.LinearColor(0.07, 0.18, 0.27, 1.0),
            roughness=0.28,
            metallic=0.15,
        ),
        "M_GNM_IonaPilotSkin_Blockout_A01": color_material(
            "M_GNM_IonaPilotSkin_Blockout_A01",
            unreal.LinearColor(0.78, 0.55, 0.38, 1.0),
        ),
        "M_GNM_IonaPilotHair_Blockout_A01": color_material(
            "M_GNM_IonaPilotHair_Blockout_A01",
            unreal.LinearColor(0.72, 0.22, 0.36, 1.0),
        ),
        "M_GNM_IonaPilotWorkwear_Blockout_A01": color_material(
            "M_GNM_IonaPilotWorkwear_Blockout_A01",
            unreal.LinearColor(0.18, 0.23, 0.28, 1.0),
        ),
    }
...
def material_instance_name(mesh_name, material_name):
    ...
    for prefix in ("M_GNM_IonaMek_", "M_GNM_IonaPilot", "M_GNM_"):
...
def assign_project_materials(mesh, project_materials):
    ...
    unreal.log("Synced {} Iona Mek material slots for {}".format(len(slots), mesh.get_name()))
...
def import_skeletal_mesh(entry):
    ...
    unreal.EditorAssetLibrary.save_asset(asset_path)
    unreal.log("Imported Iona Siegebreaker Mek skeletal mesh: {}".format(asset_path))
    return mesh
...
def ensure_skeletal_mesh_sockets(mesh):
    for socket_name, _bone_name, _location, _rotation in IONA_MEK_SOCKET_SPECS:
        remove_socket_name(mesh, socket_name)
        remove_socket_name(mesh, "SOCKET_{}".format(socket_name))

    for socket_name, bone_name, location, rotation in IONA_MEK_SOCKET_SPECS:
    ...
    unreal.EditorAssetLibrary.save_loaded_asset(mesh)
    unreal.log("Ensured {} Iona Mek sockets on {}".format(len(IONA_MEK_SOCKET_SPECS), mesh.get_name()))
...
def tag_actor(actor):
    ...
    for tag in (unreal.Name(IONA_MEK_TAG), unreal.Name("AET_NEXT_SLICE")):
        if tag not in tags:
            tags.append(tag)
...
def spawn_skeletal_mesh(label, mesh, location, yaw):
    ...
    actor.set_actor_rotation(review_rotator(0.0, yaw), False)
...
def update_startup_level(mesh):
    ...
    spawn_skeletal_mesh(
        IONA_MEK_ASSET["actor_label"],
        mesh,
        IONA_MEK_ASSET["actor_location"],
        IONA_MEK_ASSET["actor_yaw"],
    )
    ...
    unreal.log("Updated startup level with Iona Siegebreaker Mek review actor.")


def main():
    materials = ensure_materials()
    mesh = import_skeletal_mesh(IONA_MEK_ASSET)
    assign_project_materials(mesh, materials)
    ensure_physics_asset(mesh, IONA_MEK_ASSET["physics_asset"])
    ensure_review_lods_skeletal(mesh)
    ensure_skeletal_mesh_sockets(mesh)
    ensure_anim_blueprint(
        IONA_MEK_ASSET["anim_blueprint"],
        IONA_MEK_ASSET["skeleton"],
        "{}/{}".format(IONA_MEK_ASSET["destination"], IONA_MEK_ASSET["name"]),
    )
    update_startup_level(mesh)
    unreal.log("Aerathea Iona Siegebreaker Mek import complete.")
