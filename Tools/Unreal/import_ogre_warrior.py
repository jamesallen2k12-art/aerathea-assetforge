...
WARRIOR_TAG = "AET_OGRE_WARRIOR_RIVAL_REVIEW"
FBX_IMPORT_UNIFORM_SCALE = 0.01


WARRIOR_ASSET = {
    "name": "SK_OGR_Warrior_Rival_A01",
    "source": ROOT / "SourceAssets/Exports/Characters/Ogres/Warrior/SK_OGR_Warrior_Rival_A01/SK_OGR_Warrior_Rival_A01.fbx",
    "destination": "/Game/Aerathea/Characters/Ogres/Warrior",
    "physics_asset": "/Game/Aerathea/Characters/Ogres/Warrior/PHYS_OGR_Warrior_Rival_A01",
    "anim_blueprint": "/Game/Aerathea/Characters/Ogres/Warrior/ABP_OGR_Warrior_Rival_A01",
    "skeleton": "/Game/Aerathea/Characters/Ogres/Base/SK_OGR_Base_Male_A01_Skeleton",
    "actor_label": "AET_PROD_OgreWarrior_Rival_A01",
    "actor_location": unreal.Vector(-180.0, -330.0, 0.0),
    "actor_yaw": 118.0,
}
...
WARRIOR_SOCKET_SPECS = [
    ...
    ("back_large_weapon", "chest", unreal.Vector(-48.0, -24.0, 0.0), unreal.Rotator(0.0, 0.0, 0.0)),
    ("back_shield", "chest", unreal.Vector(-52.0, 24.0, 0.0), unreal.Rotator(0.0, 0.0, 0.0)),
    ("belt_front", "pelvis", unreal.Vector(46.0, 0.0, 12.0), unreal.Rotator(0.0, 0.0, 0.0)),
    ("vfx_belt_forge", "pelvis", unreal.Vector(72.0, 0.0, 18.0), unreal.Rotator(0.0, 0.0, 0.0)),
    ("vfx_shield_core", "hand_l", unreal.Vector(96.0, 42.0, 24.0), unreal.Rotator(0.0, 0.0, 0.0)),
    ("vfx_hammer_core", "hand_r", unreal.Vector(128.0, -30.0, -48.0), unreal.Rotator(0.0, 0.0, 0.0)),
...
def assign_project_materials(mesh, project_materials):
    ...
    unreal.log("Synced {} Ogre Warrior material slots for {}".format(len(slots), mesh.get_name()))
...
def update_startup_level(mesh):
    ...
    spawn_skeletal_mesh(WARRIOR_ASSET, mesh)
    if not unreal.EditorLevelLibrary.save_current_level():
        raise RuntimeError("Failed to save current level")
    for directory in (
        WARRIOR_ASSET["destination"],
        MATERIAL_PATH,
...
def main():
    ...
    log_skeleton_binding(mesh, WARRIOR_ASSET["skeleton"])
    ...
    unreal.log("Aerathea Ogre Warrior import complete.")
