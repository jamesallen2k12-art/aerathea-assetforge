...
SOURCE = ROOT / "SourceAssets/Exports/Props/Giants/BloodAxe/Cairns/SM_GIA_BloodAxeCairnSlabCluster_A01_ImageRelief/SM_GIA_BloodAxeCairnSlabCluster_A01_ImageRelief.fbx"
FBX_IMPORT_UNIFORM_SCALE = 0.01

TEXTURE_SOURCE_DIR = ROOT / "SourceAssets/Textures/Props/Giants/BloodAxe/Cairns/SM_GIA_BloodAxeCairnSlabCluster_A01_ImageRelief"
TEXTURE_DESTINATION = "/Game/Aerathea/Textures/Giants/BloodAxe/Cairns/SM_GIA_BloodAxeCairnSlabCluster_A01_ImageRelief"
TEXTURE_SOURCES = {
    "T_GIA_BloodAxeCairnSlabCluster_A01_ImageRelief_BC": TEXTURE_SOURCE_DIR / "T_GIA_BloodAxeCairnSlabCluster_A01_ImageRelief_BC.png",
    "T_GIA_BloodAxeCairnSlabCluster_A01_ImageRelief_N": TEXTURE_SOURCE_DIR / "T_GIA_BloodAxeCairnSlabCluster_A01_ImageRelief_N.png",
    "T_GIA_BloodAxeCairnSlabCluster_A01_ImageRelief_ORM": TEXTURE_SOURCE_DIR / "T_GIA_BloodAxeCairnSlabCluster_A01_ImageRelief_ORM.png",
}

MATERIAL_PATH = "/Game/Aerathea/Materials/Giants/BloodAxe/Cairns"
MATERIAL_INSTANCE_PATH = "/Game/Aerathea/Materials/Instances"
PROJECTION_MATERIAL_NAME = "M_GIA_BloodAxeCairn_ImageReliefProjection_A01"
SIDE_MATERIAL_NAME = "M_GIA_BloodAxeCairn_ImageReliefSideStone_A01"
PROJECTION_MI_NAME = "MI_GIA_BloodAxeCairnSlabCluster_A01_ImageRelief_Projection"
SIDE_MI_NAME = "MI_GIA_BloodAxeCairnSlabCluster_A01_ImageRelief_SideStone"
...
PACKAGE_DOC = "docs/assets/props/SM_GIA_BloodAxeCairnSlabCluster_A01/IMAGE_RELIEF_STATUS.md"
...
def import_textures():
    return {
        "bc": import_texture(
            "T_GIA_BloodAxeCairnSlabCluster_A01_ImageRelief_BC",
            TEXTURE_SOURCES["T_GIA_BloodAxeCairnSlabCluster_A01_ImageRelief_BC"],
            True,
        ),
        "normal": import_texture(
            "T_GIA_BloodAxeCairnSlabCluster_A01_ImageRelief_N",
            TEXTURE_SOURCES["T_GIA_BloodAxeCairnSlabCluster_A01_ImageRelief_N"],
            False,
            "TC_NORMALMAP",
        ),
        "orm": import_texture(
            "T_GIA_BloodAxeCairnSlabCluster_A01_ImageRelief_ORM",
            TEXTURE_SOURCES["T_GIA_BloodAxeCairnSlabCluster_A01_ImageRelief_ORM"],
            False,
            "TC_MASKS",
        ),
    }
...
def ensure_side_material():
    ...
    base = create_color_constant(material, unreal.LinearColor(0.30, 0.26, 0.20, 1.0), -520, -110)
    rough = create_constant(material, 0.92, -520, 90)
...
def apply_mesh_metadata(mesh):
    ...
    if not callable(setter):
        unreal.log_warning("EditorAssetLibrary.set_metadata_tag is unavailable; skipped image-relief metadata")
        return
    metadata = {
        ...
        "Aerathea.StaticMesh.SourceMethod": "concept_projected_image_relief",
        "Aerathea.StaticMesh.VisualCanonSource": "VC_GIA_BloodAxe_CairnStones_A01_A1_Crop",
        "Aerathea.StaticMesh.TextureProjection": "alpha_matted_concept_bc_normal_orm",
...
def main():
    ...
    unreal.log("Aerathea Blood Axe image-relief cairn import complete: {}".format(ASSET_PATH))
