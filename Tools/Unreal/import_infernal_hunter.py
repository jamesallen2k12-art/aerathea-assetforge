...
MATERIAL_PATH = "/Game/Aerathea/Materials/Infernals/Hunter"
MATERIAL_INSTANCE_PATH = "/Game/Aerathea/Materials/Instances"
HUNTER_TAG = "AET_INFERNAL_HUNTER_REVIEW"
FBX_IMPORT_UNIFORM_SCALE = 0.01
BASE_SKELETON_PATH = "/Game/Aerathea/Characters/Infernals/Base/SK_INF_Base_Tall_A01_Skeleton"


HUNTER_ASSET = {
    "name": "SK_INF_Hunter_A01",
    "source": ROOT / "SourceAssets/Exports/Characters/Infernals/Hunter/SK_INF_Hunter_A01/SK_INF_Hunter_A01.fbx",
    "destination": "/Game/Aerathea/Characters/Infernals/Hunter",
    "physics_asset": "/Game/Aerathea/Characters/Infernals/Hunter/PHYS_INF_Hunter_A01",
    "anim_blueprint": "/Game/Aerathea/Characters/Infernals/Hunter/ABP_INF_Hunter_A01",
    "skeleton": BASE_SKELETON_PATH,
    "actor_label": "AET_PROD_INF_Hunter_A01",
    "actor_location": unreal.Vector(1040.0, 535.0, 0.0),
    "actor_yaw": -42.0,
}


HUNTER_SOCKET_SPECS = [
    ("hand_l_claw", "hand_l", unreal.Vector(12.0, 0.0, -1.0), unreal.Rotator(0.0, 0.0, 0.0)),
    ("hand_r_claw", "hand_r", unreal.Vector(12.0, 0.0, -1.0), unreal.Rotator(0.0, 0.0, 0.0)),
    ("hand_l_cast", "hand_l", unreal.Vector(15.0, 2.0, 5.0), unreal.Rotator(0.0, 0.0, 0.0)),
    ("hand_r_cast", "hand_r", unreal.Vector(15.0, -2.0, 5.0), unreal.Rotator(0.0, 0.0, 0.0)),
    ("vfx_hand_l", "hand_l", unreal.Vector(15.0, 2.0, 5.0), unreal.Rotator(0.0, 0.0, 0.0)),
    ("vfx_hand_r", "hand_r", unreal.Vector(15.0, -2.0, 5.0), unreal.Rotator(0.0, 0.0, 0.0)),
    ("vfx_eye_l", "head", unreal.Vector(8.0, 3.0, 8.0), unreal.Rotator(0.0, 0.0, 0.0)),
    ("vfx_eye_r", "head", unreal.Vector(8.0, -3.0, 8.0), unreal.Rotator(0.0, 0.0, 0.0)),
    ("vfx_brand_chest", "chest", unreal.Vector(12.0, 0.0, -12.0), unreal.Rotator(0.0, 0.0, 0.0)),
    ("vfx_brand_forearm_l", "lowerarm_l", unreal.Vector(9.0, 0.0, 4.0), unreal.Rotator(0.0, 0.0, 0.0)),
    ("vfx_brand_forearm_r", "lowerarm_r", unreal.Vector(9.0, 0.0, 4.0), unreal.Rotator(0.0, 0.0, 0.0)),
    ("vfx_wing_root_l", "wing_l", unreal.Vector(0.0, 4.0, 4.0), unreal.Rotator(0.0, 0.0, 0.0)),
    ("vfx_wing_root_r", "wing_r", unreal.Vector(0.0, -4.0, 4.0), unreal.Rotator(0.0, 0.0, 0.0)),
    ("wing_l_tip", "wing_l", unreal.Vector(-36.0, 11.0, -12.0), unreal.Rotator(0.0, 0.0, 0.0)),
    ("wing_r_tip", "wing_r", unreal.Vector(-36.0, -11.0, -12.0), unreal.Rotator(0.0, 0.0, 0.0)),
    ("tail_tip", "tail_02", unreal.Vector(-53.0, 0.0, -8.0), unreal.Rotator(0.0, 0.0, 0.0)),
    ("vfx_tail_tip", "tail_02", unreal.Vector(-53.0, 0.0, -8.0), unreal.Rotator(0.0, 0.0, 0.0)),
    ("vfx_regen_core", "spine_01", unreal.Vector(10.0, 0.0, 0.0), unreal.Rotator(0.0, 0.0, 0.0)),
    ("vfx_mouth", "head", unreal.Vector(10.0, 0.0, -2.0), unreal.Rotator(0.0, 0.0, 0.0)),
    ("vfx_target_mark", "chest", unreal.Vector(11.0, 0.0, 4.0), unreal.Rotator(0.0, 0.0, 0.0)),
    ("vfx_brow_sight", "head", unreal.Vector(8.0, 0.0, 8.0), unreal.Rotator(0.0, 0.0, 0.0)),
    ("vfx_pursuit_burst", "chest", unreal.Vector(-18.0, 0.0, 8.0), unreal.Rotator(0.0, 0.0, 0.0)),
    ("pounce_trace", "chest", unreal.Vector(22.0, 0.0, -28.0), unreal.Rotator(0.0, 0.0, 0.0)),
    ("claw_takedown_trace", "chest", unreal.Vector(24.0, 0.0, -46.0), unreal.Rotator(0.0, 0.0, 0.0)),
    ("tail_balance_trace", "tail_02", unreal.Vector(-44.0, 0.0, -10.0), unreal.Rotator(0.0, 0.0, 0.0)),
    ("tracking_center", "pelvis", unreal.Vector(8.0, 0.0, -3.0), unreal.Rotator(0.0, 0.0, 0.0)),
    ("wing_burst_trace", "chest", unreal.Vector(-34.0, 0.0, 10.0), unreal.Rotator(0.0, 0.0, 0.0)),
]
...
def color_material(name, color, roughness=0.82, metallic=0.0, emissive=None):
...
def ensure_materials():
    return {
        "M_INF_Hunter_Skin_Blockout_A01": color_material(
            "M_INF_Hunter_Skin_Blockout_A01",
            unreal.LinearColor(0.52, 0.075, 0.060, 1.0),
        ),
        "M_INF_Hunter_HornClaw_Blockout_A01": color_material(
            "M_INF_Hunter_HornClaw_Blockout_A01",
            unreal.LinearColor(0.025, 0.020, 0.018, 1.0),
            roughness=0.70,
        ),
        "M_INF_Hunter_Wing_Blockout_A01": color_material(
            "M_INF_Hunter_Wing_Blockout_A01",
            unreal.LinearColor(0.10, 0.035, 0.040, 1.0),
        ),
        "M_INF_Hunter_HarnessLeather_Blockout_A01": color_material(
            "M_INF_Hunter_HarnessLeather_Blockout_A01",
            unreal.LinearColor(0.035, 0.034, 0.037, 1.0),
        ),
        "M_INF_Hunter_PursuitArmor_Blockout_A01": color_material(
            "M_INF_Hunter_PursuitArmor_Blockout_A01",
            unreal.LinearColor(0.028, 0.026, 0.032, 1.0),
            roughness=0.62,
            metallic=0.45,
        ),
        "M_INF_Hunter_BoneHorn_Blockout_A01": color_material(
            "M_INF_Hunter_BoneHorn_Blockout_A01",
            unreal.LinearColor(0.50, 0.43, 0.32, 1.0),
        ),
        "M_INF_Hunter_SightMarkGlow_Blockout_A01": color_material(
            "M_INF_Hunter_SightMarkGlow_Blockout_A01",
            unreal.LinearColor(0.72, 0.06, 1.0, 1.0),
            roughness=0.25,
            emissive=unreal.LinearColor(1.4, 0.08, 2.8, 1.0),
        ),
    }
...
def material_instance_name(mesh_name, material_name):
    ...
    for prefix in ("M_INF_Hunter_", "M_INF_"):
...
def assign_project_materials(mesh, project_materials):
    ...
    unreal.log("Synced {} Infernal Hunter material slots for {}".format(len(slots), mesh.get_name()))
...
def import_skeletal_mesh(entry):
    ...
    if skeleton is None:
        raise RuntimeError("Missing base Infernal skeleton: {}".format(entry["skeleton"]))
    ...
    unreal.EditorAssetLibrary.save_asset(asset_path)
    unreal.log("Imported Infernal Hunter skeletal mesh: {}".format(asset_path))
    return mesh
...
def ensure_skeletal_mesh_sockets(mesh):
    for socket_name, _bone_name, _location, _rotation in HUNTER_SOCKET_SPECS:
        remove_socket_name(mesh, socket_name)
        remove_socket_name(mesh, "SOCKET_{}".format(socket_name))

    for socket_name, bone_name, location, rotation in HUNTER_SOCKET_SPECS:
    ...
    unreal.EditorAssetLibrary.save_loaded_asset(mesh)
    unreal.log("Ensured {} Infernal Hunter sockets on {}".format(len(HUNTER_SOCKET_SPECS), mesh.get_name()))
...
def tag_actor(actor):
    ...
    for tag in (unreal.Name(HUNTER_TAG), unreal.Name("AET_NEXT_SLICE")):
        if tag not in tags:
            tags.append(tag)
...
def update_startup_level(mesh):
    ...
    spawn_skeletal_mesh(
        HUNTER_ASSET["actor_label"],
        mesh,
        HUNTER_ASSET["actor_location"],
        HUNTER_ASSET["actor_yaw"],
    )
    ...
    unreal.log("Updated startup level with Infernal Hunter review actor.")


def main():
    materials = ensure_materials()
    mesh = import_skeletal_mesh(HUNTER_ASSET)
    assign_project_materials(mesh, materials)
    ensure_physics_asset(mesh, HUNTER_ASSET["physics_asset"])
    ensure_review_lods_skeletal(mesh)
    ensure_skeletal_mesh_sockets(mesh)
    ensure_anim_blueprint(
        HUNTER_ASSET["anim_blueprint"],
        HUNTER_ASSET["skeleton"],
        "{}/{}".format(HUNTER_ASSET["destination"], HUNTER_ASSET["name"]),
    )
    update_startup_level(mesh)
    unreal.log("Aerathea Infernal Hunter import complete.")
