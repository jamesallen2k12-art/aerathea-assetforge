...
SOURCE = ROOT / "SourceAssets/Exports/Props/Giants/BloodAxe/Cairns/SM_GIA_BloodAxeCairnSlabCluster_A01_BacksideRepair/SM_GIA_BloodAxeCairnSlabCluster_A01_BacksideRepair.fbx"
FBX_IMPORT_UNIFORM_SCALE = 1.0

TEXTURE_SOURCE_DIR = ROOT / "SourceAssets/Textures/Props/Giants/BloodAxe/Cairns/SM_GIA_BloodAxeCairnSlabCluster_A01_BacksideRepair"
TEXTURE_DESTINATION = "/Game/Aerathea/Textures/Giants/BloodAxe/Cairns/SM_GIA_BloodAxeCairnSlabCluster_A01_BacksideRepair"
MATERIAL_PATH = "/Game/Aerathea/Materials/Giants/BloodAxe/Cairns"
MATERIAL_INSTANCE_PATH = "/Game/Aerathea/Materials/Instances"
PACKAGE_DOC = "docs/assets/props/SM_GIA_BloodAxeCairnSlabCluster_A01/BACKSIDE_REPAIR_STATUS.md"

MATERIAL_SPECS = {
    "stone": {
        "parent": "M_GIA_BloodAxeCairn_BacksideRepairStone_A01",
        "instance": "MI_GIA_BloodAxeCairnSlabCluster_A01_BacksideRepair_Stone",
        "slot_terms": ("stone", "slab"),
        "bc": TEXTURE_SOURCE_DIR / "T_GIA_BloodAxeCairnSlabCluster_A01_BacksideRepair_Stone_BC.png",
        "n": TEXTURE_SOURCE_DIR / "T_GIA_BloodAxeCairnSlabCluster_A01_BacksideRepair_Stone_N.png",
        "orm": TEXTURE_SOURCE_DIR / "T_GIA_BloodAxeCairnSlabCluster_A01_BacksideRepair_Stone_ORM.png",
        "bc_asset": "T_GIA_Cairn_A01_BackRepair_Stone_BC",
        "n_asset": "T_GIA_Cairn_A01_BackRepair_Stone_N",
        "orm_asset": "T_GIA_Cairn_A01_BackRepair_Stone_ORM",
        "roughness": 0.9,
        "color": unreal.LinearColor(0.22, 0.21, 0.18, 1.0),
        "metallic": 0.0,
    },
    "earth": {
        "parent": "M_GIA_BloodAxeCairn_BacksideRepairEarthAsh_A01",
        "instance": "MI_GIA_BloodAxeCairnSlabCluster_A01_BacksideRepair_EarthAsh",
        "slot_terms": ("earth", "ash", "mud", "ground"),
        "bc": TEXTURE_SOURCE_DIR / "T_GIA_BloodAxeCairnSlabCluster_A01_BacksideRepair_EarthAsh_BC.png",
        "n": TEXTURE_SOURCE_DIR / "T_GIA_BloodAxeCairnSlabCluster_A01_BacksideRepair_EarthAsh_N.png",
        "orm": TEXTURE_SOURCE_DIR / "T_GIA_BloodAxeCairnSlabCluster_A01_BacksideRepair_EarthAsh_ORM.png",
        "bc_asset": "T_GIA_Cairn_A01_BackRepair_EarthAsh_BC",
        "n_asset": "T_GIA_Cairn_A01_BackRepair_EarthAsh_N",
        "orm_asset": "T_GIA_Cairn_A01_BackRepair_EarthAsh_ORM",
        "roughness": 0.94,
        "color": unreal.LinearColor(0.45, 0.32, 0.20, 1.0),
        "metallic": 0.0,
    },
    "rawhide": {
        "parent": "M_GIA_BloodAxeCairn_BacksideRepairRawhide_A01",
        "instance": "MI_GIA_BloodAxeCairnSlabCluster_A01_BacksideRepair_Rawhide",
        "slot_terms": ("rawhide", "binding", "lashing"),
        "bc": TEXTURE_SOURCE_DIR / "T_GIA_BloodAxeCairnSlabCluster_A01_BacksideRepair_Rawhide_BC.png",
        "n": TEXTURE_SOURCE_DIR / "T_GIA_BloodAxeCairnSlabCluster_A01_BacksideRepair_Rawhide_N.png",
        "orm": TEXTURE_SOURCE_DIR / "T_GIA_BloodAxeCairnSlabCluster_A01_BacksideRepair_Rawhide_ORM.png",
        "bc_asset": "T_GIA_Cairn_A01_BackRepair_Rawhide_BC",
        "n_asset": "T_GIA_Cairn_A01_BackRepair_Rawhide_N",
        "orm_asset": "T_GIA_Cairn_A01_BackRepair_Rawhide_ORM",
        "roughness": 0.86,
        "color": unreal.LinearColor(0.62, 0.36, 0.16, 1.0),
        "metallic": 0.0,
    },
    "red": {
        "parent": "M_GIA_BloodAxeCairn_BacksideRepairBloodAxeRedPaint_A01",
        "instance": "MI_GIA_BloodAxeCairnSlabCluster_A01_BacksideRepair_BloodAxeRedPaint",
        "slot_terms": ("red", "paint", "bloodaxe"),
        "bc": TEXTURE_SOURCE_DIR / "T_GIA_BloodAxeCairnSlabCluster_A01_BacksideRepair_BloodAxeRedPaint_BC.png",
        "n": TEXTURE_SOURCE_DIR / "T_GIA_BloodAxeCairnSlabCluster_A01_BacksideRepair_BloodAxeRedPaint_N.png",
        "orm": TEXTURE_SOURCE_DIR / "T_GIA_BloodAxeCairnSlabCluster_A01_BacksideRepair_BloodAxeRedPaint_ORM.png",
        "bc_asset": "T_GIA_Cairn_A01_BackRepair_RedPaint_BC",
        "n_asset": "T_GIA_Cairn_A01_BackRepair_RedPaint_N",
        "orm_asset": "T_GIA_Cairn_A01_BackRepair_RedPaint_ORM",
        "roughness": 0.78,
        "color": unreal.LinearColor(0.92, 0.10, 0.04, 1.0),
        "metallic": 0.0,
    },
}
...
def import_textures():
    if unreal.EditorAssetLibrary.does_directory_exist(TEXTURE_DESTINATION):
        unreal.EditorAssetLibrary.delete_directory(TEXTURE_DESTINATION)
    ensure_directory(TEXTURE_DESTINATION)

    imported = {}
    for key, spec in MATERIAL_SPECS.items():
        imported[key] = {
            "bc": import_texture(spec["bc_asset"], spec["bc"], True),
            "normal": import_texture(spec["n_asset"], spec["n"], False, "TC_NORMALMAP"),
            "orm": import_texture(spec["orm_asset"], spec["orm"], False, "TC_MASKS"),
        }
    return imported
...
def apply_mesh_metadata(mesh):
    ...
    if not callable(setter):
        unreal.log_warning("EditorAssetLibrary.set_metadata_tag is unavailable; skipped BacksideRepair cairn metadata")
        return
    metadata = {
        ...
        "Aerathea.StaticMesh.SourceMethod": "hand_authored_360_dcc_backside_repair_from_approved_a1_concept_direction",
        "Aerathea.StaticMesh.VisualCanonSource": "VC_GIA_BloodAxe_CairnStones_A01_A1_Crop",
        "Aerathea.StaticMesh.TextureProjection": "authored_material_sets_no_front_card_projection_corrected_rear",
...
def main():
    ...
    unreal.log("Aerathea Blood Axe BacksideRepair cairn import candidate: {}".format(ASSET_PATH))
