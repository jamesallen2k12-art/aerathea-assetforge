...
TEXTURE_PATHS = [
    "/Game/Aerathea/Textures/Giants/BloodAxe/Cairns/SM_GIA_BloodAxeCairnSlabCluster_A01_BacksideRepair/T_GIA_Cairn_A01_BackRepair_Stone_BC",
    "/Game/Aerathea/Textures/Giants/BloodAxe/Cairns/SM_GIA_BloodAxeCairnSlabCluster_A01_BacksideRepair/T_GIA_Cairn_A01_BackRepair_Stone_N",
    "/Game/Aerathea/Textures/Giants/BloodAxe/Cairns/SM_GIA_BloodAxeCairnSlabCluster_A01_BacksideRepair/T_GIA_Cairn_A01_BackRepair_Stone_ORM",
    "/Game/Aerathea/Textures/Giants/BloodAxe/Cairns/SM_GIA_BloodAxeCairnSlabCluster_A01_BacksideRepair/T_GIA_Cairn_A01_BackRepair_EarthAsh_BC",
    "/Game/Aerathea/Textures/Giants/BloodAxe/Cairns/SM_GIA_BloodAxeCairnSlabCluster_A01_BacksideRepair/T_GIA_Cairn_A01_BackRepair_EarthAsh_N",
    "/Game/Aerathea/Textures/Giants/BloodAxe/Cairns/SM_GIA_BloodAxeCairnSlabCluster_A01_BacksideRepair/T_GIA_Cairn_A01_BackRepair_EarthAsh_ORM",
    "/Game/Aerathea/Textures/Giants/BloodAxe/Cairns/SM_GIA_BloodAxeCairnSlabCluster_A01_BacksideRepair/T_GIA_Cairn_A01_BackRepair_Rawhide_BC",
    "/Game/Aerathea/Textures/Giants/BloodAxe/Cairns/SM_GIA_BloodAxeCairnSlabCluster_A01_BacksideRepair/T_GIA_Cairn_A01_BackRepair_Rawhide_N",
    "/Game/Aerathea/Textures/Giants/BloodAxe/Cairns/SM_GIA_BloodAxeCairnSlabCluster_A01_BacksideRepair/T_GIA_Cairn_A01_BackRepair_Rawhide_ORM",
    "/Game/Aerathea/Textures/Giants/BloodAxe/Cairns/SM_GIA_BloodAxeCairnSlabCluster_A01_BacksideRepair/T_GIA_Cairn_A01_BackRepair_RedPaint_BC",
    "/Game/Aerathea/Textures/Giants/BloodAxe/Cairns/SM_GIA_BloodAxeCairnSlabCluster_A01_BacksideRepair/T_GIA_Cairn_A01_BackRepair_RedPaint_N",
    "/Game/Aerathea/Textures/Giants/BloodAxe/Cairns/SM_GIA_BloodAxeCairnSlabCluster_A01_BacksideRepair/T_GIA_Cairn_A01_BackRepair_RedPaint_ORM",
]
MATERIAL_PATHS = [
    "/Game/Aerathea/Materials/Giants/BloodAxe/Cairns/M_GIA_BloodAxeCairn_BacksideRepairStone_A01",
    "/Game/Aerathea/Materials/Giants/BloodAxe/Cairns/M_GIA_BloodAxeCairn_BacksideRepairEarthAsh_A01",
    "/Game/Aerathea/Materials/Giants/BloodAxe/Cairns/M_GIA_BloodAxeCairn_BacksideRepairRawhide_A01",
    "/Game/Aerathea/Materials/Giants/BloodAxe/Cairns/M_GIA_BloodAxeCairn_BacksideRepairBloodAxeRedPaint_A01",
]
...
COMMON_METADATA = {
    "Aerathea.StaticMesh.Package": "SM_GIA_BloodAxeCairnSlabCluster_A01_BacksideRepair",
...
def validate_mesh_bounds(failures, mesh, measurements):
    ...
    if height < 130.0 or height > 190.0:
        failures.append("{} height {:.2f} cm outside expected BacksideRepair cairn envelope".format(MESH_PATH, height))
    if width < 300.0 or width > 420.0:
        failures.append("{} width {:.2f} cm outside expected BacksideRepair cairn envelope".format(MESH_PATH, width))
    if depth < 230.0 or depth > 340.0:
        failures.append("{} depth {:.2f} cm outside expected BacksideRepair cairn envelope".format(MESH_PATH, depth))
...
def main():
    ...
    if failures:
        ...
        raise RuntimeError("Blood Axe BacksideRepair cairn validation failed with {} issue(s)".format(len(failures)))

    height, width, depth = measurements[0] if measurements else ("unavailable", "unavailable", "unavailable")
    unreal.log(
        "Blood Axe BacksideRepair cairn validation passed: {:.2f}h x {:.2f}w x {:.2f}d cm, 4 LODs, 4 materials, 12 textures, startup actor {}, broad collision enabled.".format(
            height,
            width,
            depth,
            ACTOR_LABEL,
