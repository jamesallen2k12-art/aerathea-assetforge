...
MESH_PATH = "/Game/Aerathea/Props/Giants/BloodAxe/Cairns/SM_GIA_BloodAxeCairnSlabCluster_A01_Complete"
TEXTURE_PATHS = [
    "/Game/Aerathea/Textures/Giants/BloodAxe/Cairns/SM_GIA_BloodAxeCairnSlabCluster_A01_Complete/T_GIA_BloodAxeCairnSlabCluster_A01_Complete_Stone_BC",
    "/Game/Aerathea/Textures/Giants/BloodAxe/Cairns/SM_GIA_BloodAxeCairnSlabCluster_A01_Complete/T_GIA_BloodAxeCairnSlabCluster_A01_Complete_Stone_N",
    "/Game/Aerathea/Textures/Giants/BloodAxe/Cairns/SM_GIA_BloodAxeCairnSlabCluster_A01_Complete/T_GIA_BloodAxeCairnSlabCluster_A01_Complete_Stone_ORM",
    "/Game/Aerathea/Textures/Giants/BloodAxe/Cairns/SM_GIA_BloodAxeCairnSlabCluster_A01_Complete/T_GIA_BloodAxeCairnSlabCluster_A01_Complete_EarthAsh_BC",
    "/Game/Aerathea/Textures/Giants/BloodAxe/Cairns/SM_GIA_BloodAxeCairnSlabCluster_A01_Complete/T_GIA_BloodAxeCairnSlabCluster_A01_Complete_EarthAsh_N",
    "/Game/Aerathea/Textures/Giants/BloodAxe/Cairns/SM_GIA_BloodAxeCairnSlabCluster_A01_Complete/T_GIA_BloodAxeCairnSlabCluster_A01_Complete_EarthAsh_ORM",
    "/Game/Aerathea/Textures/Giants/BloodAxe/Cairns/SM_GIA_BloodAxeCairnSlabCluster_A01_Complete/T_GIA_BloodAxeCairnSlabCluster_A01_Complete_Rawhide_BC",
    "/Game/Aerathea/Textures/Giants/BloodAxe/Cairns/SM_GIA_BloodAxeCairnSlabCluster_A01_Complete/T_GIA_BloodAxeCairnSlabCluster_A01_Complete_Rawhide_N",
    "/Game/Aerathea/Textures/Giants/BloodAxe/Cairns/SM_GIA_BloodAxeCairnSlabCluster_A01_Complete/T_GIA_BloodAxeCairnSlabCluster_A01_Complete_Rawhide_ORM",
    "/Game/Aerathea/Textures/Giants/BloodAxe/Cairns/SM_GIA_BloodAxeCairnSlabCluster_A01_Complete/T_GIA_BloodAxeCairnSlabCluster_A01_Complete_BloodAxeRedPaint_BC",
    "/Game/Aerathea/Textures/Giants/BloodAxe/Cairns/SM_GIA_BloodAxeCairnSlabCluster_A01_Complete/T_GIA_BloodAxeCairnSlabCluster_A01_Complete_BloodAxeRedPaint_N",
    "/Game/Aerathea/Textures/Giants/BloodAxe/Cairns/SM_GIA_BloodAxeCairnSlabCluster_A01_Complete/T_GIA_BloodAxeCairnSlabCluster_A01_Complete_BloodAxeRedPaint_ORM",
]
MATERIAL_PATHS = [
    "/Game/Aerathea/Materials/Giants/BloodAxe/Cairns/M_GIA_BloodAxeCairn_CompleteStone_A01",
    "/Game/Aerathea/Materials/Giants/BloodAxe/Cairns/M_GIA_BloodAxeCairn_CompleteEarthAsh_A01",
    "/Game/Aerathea/Materials/Giants/BloodAxe/Cairns/M_GIA_BloodAxeCairn_CompleteRawhide_A01",
    "/Game/Aerathea/Materials/Giants/BloodAxe/Cairns/M_GIA_BloodAxeCairn_CompleteBloodAxeRedPaint_A01",
]
MATERIAL_INSTANCE_PATHS = [
    "/Game/Aerathea/Materials/Instances/MI_GIA_BloodAxeCairnSlabCluster_A01_Complete_Stone",
    "/Game/Aerathea/Materials/Instances/MI_GIA_BloodAxeCairnSlabCluster_A01_Complete_EarthAsh",
    "/Game/Aerathea/Materials/Instances/MI_GIA_BloodAxeCairnSlabCluster_A01_Complete_Rawhide",
    "/Game/Aerathea/Materials/Instances/MI_GIA_BloodAxeCairnSlabCluster_A01_Complete_BloodAxeRedPaint",
]

ACTOR_LABEL = "AET_PROD_GIA_BloodAxeCairnSlabCluster_A01_Complete"
EXPECTED_LOCATION = unreal.Vector(12000.0, 10000.0, 0.0)
EXPECTED_YAW = -18.0
EXPECTED_TAGS = [
    "AET_FIRST_SLICE",
...
COMMON_METADATA = {
    "Aerathea.StaticMesh.Package": "SM_GIA_BloodAxeCairnSlabCluster_A01_Complete",
    ...
    for texture_path in TEXTURE_PATHS:
        ...
        if callable(get_x) and callable(get_y):
            ...
            if width < 512 or height < 512:
                failures.append("{} has texture size {}x{}, expected at least 512".format(texture_path, width, height))
...
def validate_mesh_bounds(failures, mesh, measurements):
    ...
    if height < 130.0 or height > 190.0:
        failures.append("{} height {:.2f} cm outside expected complete cairn envelope".format(MESH_PATH, height))
    if width < 300.0 or width > 420.0:
        failures.append("{} width {:.2f} cm outside expected complete cairn envelope".format(MESH_PATH, width))
    if depth < 190.0 or depth > 290.0:
        failures.append("{} depth {:.2f} cm outside expected complete cairn envelope".format(MESH_PATH, depth))
...
def main():
    ...
    if failures:
        ...
        raise RuntimeError("Blood Axe complete cairn validation failed with {} issue(s)".format(len(failures)))

    height, width, depth = measurements[0] if measurements else ("unavailable", "unavailable", "unavailable")
    unreal.log(
        "Blood Axe complete cairn validation passed: {:.2f}h x {:.2f}w x {:.2f}d cm, 4 LODs, 4 materials, 12 textures, startup actor {}, broad collision enabled.".format(
            height,
            width,
            depth,
            ACTOR_LABEL,
