...
def main() -> None:
    ...
    build_specs = [
        ...
        ("D100 Trapezohedron", lambda: add_d100_trapezohedron("P01C_D100Trapezohedron_Source", (0.0, 0.0, 1.1), materials["d100"]), 4.0),
        ("Tetrahedron", lambda: add_tetrahedron("P01C_Tetrahedron_Source", (0.0, 0.0, 1.0), materials["tetra"]), 4.1),
        ("Regular Octahedron", lambda: add_regular_octahedron("P01C_RegularOctahedron_Source", (0.0, 0.0, 1.25), materials["octa"]), 4.1),
        ...
        ("Prolate Spheroid", lambda: add_prolate_spheroid("P01C_ProlateSpheroid_Source", (0.0, 0.0, 1.24), materials["spheroid"]), 4.0),
    ]
