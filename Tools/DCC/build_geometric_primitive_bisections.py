...
from Tools.DCC.build_geometric_primitive_fundamentals import (  # noqa: E402
    ...
    add_hexagonal_prism,
    add_icosahedron,
    add_d100_trapezohedron,
    add_prolate_spheroid,
    add_parallelepiped,
    add_pentagonal_trapezohedron,
    add_rectangular_slab,
    add_regular_octahedron,
    add_sphere,
    add_tetrahedron,
    configure_scene,
    ensure_dir,
...
def build_materials(prefix: str = "P01B") -> dict[str, bpy.types.Material]:
    materials = {
        ...
        "octa": make_material(f"M_{prefix}_RegularOctahedron", (0.47, 0.56, 0.48)),
        ...
        "d100": make_material(f"M_{prefix}_D100Trapezohedron", (0.45, 0.48, 0.58)),
        "cone": make_material(f"M_{prefix}_Cone", (0.58, 0.48, 0.38)),
        "sphere": make_material(f"M_{prefix}_SmoothSphere", (0.46, 0.55, 0.58)),
        "spheroid": make_material(f"M_{prefix}_ProlateSpheroid", (0.55, 0.48, 0.38)),
...
def main() -> None:
    ...
    build_specs = [
        ...
        ("D100 Trapezohedron", lambda: add_d100_trapezohedron("P01B_D100Trapezohedron_Source", (0.0, 0.0, 1.1), materials["d100"]), default_bisect_plane, 4.0),
        ...
        ("Regular Octahedron", lambda: add_regular_octahedron("P01B_RegularOctahedron_Source", (0.0, 0.0, 1.25), materials["octa"]), default_bisect_plane, 4.1),
        ...
        ("Prolate Spheroid", lambda: add_prolate_spheroid("P01B_ProlateSpheroid_Source", (0.0, 0.0, 1.24), materials["spheroid"]), default_bisect_plane, 4.0),
    ]
