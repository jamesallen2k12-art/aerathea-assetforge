...
def main() -> int:
    ...
    output = {
        ...
        "date": "2026-07-21",
        "status": "approved_authoritative_multi_row_dimension_statistics",
        ...
        "flamestrike_output_approval": {
            "statement": "approved",
            "date": "2026-07-21",
            "scope": "A12 multi-row median dimensions: C002 112.291667 x 76.651584 cm; C003 129.548611 x 96.063348 cm; C004 retained at 140 x 110 cm",
            "exclusions": "no geometry rebuild, hidden-interface construction, Blender, FBX, Unreal, Fully game-ready, library, or visual-canon promotion",
        },
