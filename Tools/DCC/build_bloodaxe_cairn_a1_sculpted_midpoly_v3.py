#!/usr/bin/env python3
"""Build A1 Blood Axe cairn as a sculpted mid-poly DCC candidate, pass 09.

Run with:
    Tools/Blender/blender-4.5.11-linux-x64/blender --background --python Tools/DCC/build_bloodaxe_cairn_a1_sculpted_midpoly_v3.py

This pass corrects the main painted-slab orientation failure in pass 08. The
hero stone is modeled as a broad tilted face slab so the Blood Axe paint reads
from the front, matching the approved A1 concept.
"""
...
REVIEW_ROOT = ROOT / "Saved" / "Automation" / "DCC" / "SM_GIA_BloodAxeCairnSlabCluster_A01_SculptedMidpolyV3"

ASSET_NAME = "SM_GIA_BloodAxeCairnSlabCluster_A01_SculptedMidpolyV3"
        ...
        for index in range(40):
            objects.append(
                add_face_decal(
                    ...
                    (rng.uniform(1.2, 3.0), rng.uniform(10, 28)),
        ...
        for index in range(22):
            objects.append(
                add_face_decal(
                    ...
                    (rng.uniform(0.8, 1.6), rng.uniform(16, 42)),
