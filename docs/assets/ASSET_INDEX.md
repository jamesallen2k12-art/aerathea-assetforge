...
| `SM_AET_PortalArch_A01` | Blender source and FBX generated, imported to Unreal, startup portal visual replaced, validation passing; current import uses older smaller scale assumptions and awaits old/mysterious/awe-inspiring 10 m universal portal exploration plus rebuild/rescale | `docs/assets/props/SM_AET_PortalArch_A01/PRODUCTION_PACKAGE.md` |
...
| `SM_INF_HornWingArch_A01` | Production package and modeling handoff ready for the Balgoroth cult gate/threshold child; DCC build not started | `docs/assets/props/SM_INF_HornWingArch_A01/PRODUCTION_PACKAGE.md` |
...
| `SK_OGR_Base_A01` | First-pass male/female Ogre body sources generated, imported to Unreal, material instances and LOD0-LOD3 generated, sockets/physics/ABP placeholders created, startup validation passing, and focused male shared-skeleton validator passing; final sculpt/retopo/UVs/textures and animation remain pending | `docs/assets/characters/SK_OGR_Base_A01/PRODUCTION_PACKAGE.md` |
| `SK_OGR_Teknomancer_A01` | First-pass Ogre Teknomancer class-fit source generated, imported to Unreal on the shared Ogre male skeleton, material instances and LOD0-LOD3 generated, sockets/physics/ABP placeholder created, startup review actor placed, and focused shared-skeleton validation passing; final sculpt, rig fit, UVs/textures, tuned physics, and animation remain pending | `docs/assets/characters/SK_OGR_Teknomancer_A01/PRODUCTION_PACKAGE.md` |
| `SK_OGR_Warrior_Rival_A01` | First-pass Ogre Warrior source generated, imported to Unreal, material instances and LOD0-LOD3 generated, shield/hammer/VFX sockets added, physics asset and ABP placeholder created, startup review actor placed; final sculpt, shared-skeleton rig pass, UVs/textures, tuned physics, and animation remain pending | `docs/assets/characters/SK_OGR_Warrior_Rival_A01/PRODUCTION_PACKAGE.md` |
| `SK_OGR_Shaman_A01` | First-pass Ogre Shaman class-fit source generated, imported to Unreal on the shared Ogre male skeleton, material instances and LOD0-LOD3 generated, sockets/physics/ABP placeholder created, startup review actor placed, validation passing; final sculpt/UVs/textures/tuned physics and animation pending | `docs/assets/characters/SK_OGR_Shaman_A01/PRODUCTION_PACKAGE.md` |
| `SK_OGR_Necromancer_A01` | First-pass Ogre Necromancer class-fit source generated, imported to Unreal on the shared Ogre male skeleton, material instances and LOD0-LOD3 generated, sockets/physics/ABP placeholder created, startup review actor placed, validation passing; final sculpt/UVs/textures/tuned physics and animation pending | `docs/assets/characters/SK_OGR_Necromancer_A01/PRODUCTION_PACKAGE.md` |
...
| Asset | Status | Package |
| --- | --- | --- |
| `BP_AET_Portal_A01` | Native preview state/overlap/use-cooldown behavior implemented; Blueprint asset compiled; startup validation passing; final target is universal, race-neutral, and scaled for a 10 m / about 33 ft clear traversal portal | `docs/assets/blueprints/BP_AET_Portal_A01/PRODUCTION_PACKAGE.md` |
...
| `VFX_INF_AbyssalSpellcasting_A01` | Infernal combat spellcasting VFX production package ready for mage, brand-channel, regeneration, invisible-sight, and rage effects; Niagara/material authoring not started | `docs/assets/vfx/VFX_INF_AbyssalSpellcasting_A01/PRODUCTION_PACKAGE.md` |
