...
| `BP_GNM_HeavyMekShieldwall_A01` | Approved first-pass native Blueprintable actor, Blueprint asset, projector mesh, strengthened segmented VFX helper, material states, impact-location API, scalar VFX parameters, sockets, LOD0-LOD3, startup review actor, validation contract, native Niagara hook, assigned `NS_GNM_AetherShieldWall_A01` target, and template-derived shield emitter assets created; bespoke Niagara graph polish pending | `docs/assets/blueprints/BP_GNM_HeavyMekShieldwall_A01/PRODUCTION_PACKAGE.md` |
...
| `VFX_GNM_AetherShieldWall_A01` | First-pass helper mesh/material state implementation, native shieldwall VFX parameter contract, native Niagara component hook, assigned `NS_GNM_AetherShieldWall_A01` target, and template-derived shield emitter target assets exist; bespoke graph polish pending | `docs/assets/vfx/VFX_GNM_AetherShieldWall_A01/PRODUCTION_PACKAGE.md` |
