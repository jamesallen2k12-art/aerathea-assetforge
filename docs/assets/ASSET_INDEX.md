...
| `SM_OGR_CrudeTekPylon_A01` | Production package, modeling handoff, build/import status, material plan, socket plan, collision plan, LOD plan, and future Blueprint state notes ready; DCC build not started | `docs/assets/props/SM_OGR_CrudeTekPylon_A01/PRODUCTION_PACKAGE.md` |
...
| `KIT_GNM_OGR_RivalryEncounter_A01` | Source intake and production package ready for 21 Gnome-vs-Ogre encounter images plus 4 heavy Mek variants; approved sequence is complete through `BP_GNM_HeavyMekShieldwall_A01`, `SK_OGR_Teknomancer_A01`, `SK_GNM_HeavyMek_Rivalry_A01`, `SK_OGR_Warrior_Rival_A01`, `SM_OGR_CairnBattleGate_A01`, `SK_OGR_Shaman_A01`, `SK_OGR_Necromancer_A01`, `SK_CRE_Manticore_A01`, `SK_CRE_Manticore_Interrupt_A01`, `SM_OGR_CrudeTekPylon_A01`, `BP_GNM_OGR_BattlefieldEncounter_A01`, and shieldwall Blueprint/VFX contract polish | `docs/assets/kits/KIT_GNM_OGR_RivalryEncounter_A01/PRODUCTION_PACKAGE.md` |
| `KIT_OGR_Teknomancy_A01` | Production package and child intake ready; `SM_OGR_CrudeTekPylon_A01` child package ready, other Teknomancy child props pending | `docs/assets/kits/KIT_OGR_Teknomancy_A01/PRODUCTION_PACKAGE.md` |
...
| `SK_OGR_Shaman_A01` | Production package, modeling handoff, build/import status, material plan, LOD plan, collision plan, sockets, and animation hooks ready; DCC build not started | `docs/assets/characters/SK_OGR_Shaman_A01/PRODUCTION_PACKAGE.md` |
| `SK_OGR_Necromancer_A01` | Production package, modeling handoff, build/import status, material plan, LOD plan, collision plan, sockets, and animation hooks ready; DCC build not started | `docs/assets/characters/SK_OGR_Necromancer_A01/PRODUCTION_PACKAGE.md` |
...
| `SK_CRE_Manticore_A01` | Base production package, source concept intake, modeling handoff, skeleton/proportion plan, material plan, LOD plan, collision plan, sockets, and build/import status ready; DCC build waits for visual approval | `docs/assets/creatures/SK_CRE_Manticore_A01/PRODUCTION_PACKAGE.md` |
| `SK_CRE_Manticore_Interrupt_A01` | Encounter-variant production package, modeling handoff, and build/import status ready; now references base `SK_CRE_Manticore_A01`, with DCC build waiting for base approval/import | `docs/assets/creatures/SK_CRE_Manticore_Interrupt_A01/PRODUCTION_PACKAGE.md` |
...
| `BP_GNM_HeavyMekShieldwall_A01` | Approved first-pass native Blueprintable actor, Blueprint asset, projector mesh, strengthened segmented VFX helper, material states, impact-location API, scalar VFX parameters, sockets, LOD0-LOD3, startup review actor, and validation contract implemented; final Niagara art-pass handoff ready, Unreal Niagara not authored | `docs/assets/blueprints/BP_GNM_HeavyMekShieldwall_A01/PRODUCTION_PACKAGE.md` |
| `BP_GNM_OGR_BattlefieldEncounter_A01` | Production package, implementation handoff, build/import status, dependency contract, phase-state plan, actor slots, collision volumes, variables, events, and optional-branch gates ready; Blueprint asset not created | `docs/assets/blueprints/BP_GNM_OGR_BattlefieldEncounter_A01/PRODUCTION_PACKAGE.md` |
