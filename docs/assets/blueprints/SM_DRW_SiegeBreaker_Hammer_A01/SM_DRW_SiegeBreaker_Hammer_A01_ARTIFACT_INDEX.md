...
| `SM_DRW_SiegeBreaker_Hammer_A01_A12_R7_COMPONENT_GEOMETRY_RECOVERY_PLAN.md` | `draft; approval required` | Reset-safe seven-step plan for component-specific measurement, half-face centerline/pitch, zero inter-cap stone fill, tapered rotational caps/pommel, isolated approvals, and final half/mirror review. |
