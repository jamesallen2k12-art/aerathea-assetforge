...
| `manifests/A12_R7_STEP01_COMPONENT_REGISTRATION_A01.json` | `candidate measurement record` | Exact six-source marks, component ledger, discrete formulas, five blocked rules, and no-interpretation firewall; pending Flamestrike approval or revision. |
...
| `evidence/A12_R7_STEP01_COMPONENT_REGISTRATION_A01/SM_DRW_SiegeBreaker_Hammer_A01_A12_R7_STEP01_COMPONENT_REGISTRATION_A01_REVIEW_BOARD.png` | `candidate review artifact` | Measurement-only board with sparse exact marks and blocked unknowns; SHA `2f9bc9f...d75705b`. |
| `review/A12_R7_STEP01_COMPONENT_REGISTRATION_A01_REVIEW.md` | `candidate review record` | Concise evidence boundary, five blockers, and Flamestrike stop gate. |
| `steps/A12_R7_STEP01_COMPONENT_REGISTRATION_A01_OUTPUT_RECORD.md` | `authoritative status record` | Hash locks the Step 01 output, audit, blocked decisions, and continuing prohibition on Step 02/DCC/Unreal. |
