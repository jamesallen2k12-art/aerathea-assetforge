...
| `SourceAssets/Blender/Weapons/Dwarven/SM_DRW_SiegeBreaker_Hammer_A01/A12_R5_CylindricalHaft_A04/SM_DRW_SiegeBreaker_Hammer_A01_A12_R5_CylindricalHaft_A04.blend` | `DCC source candidate pending Flamestrike visual decision; local only` | Fresh two-object half/mirror assembly with a true circular haft, separate front/back 180-degree material sets, and static UVs. SHA `085f5b5d...16ec`. |
| `review/A12_R5_CYLINDRICAL_HAFT_A04_REVIEW.png` | `candidate review artifact` | Exact four-view source comparisons plus colored and independent gray three-quarter proofs. SHA `2b00b55d...c79f`. |
...
| `steps/A12_R5_CYLINDRICAL_HAFT_A04_OUTPUT_RECORD.md` | `authoritative status record` | Hash locks the technical pass, records the artifact ceiling, and stops at Flamestrike's visual decision. |
