...
- Date: 2026-07-21
- Approver for execution: Flamestrike
- Authority statement: `resume ... You have full Approval and Authorization
  to do whatever you need to do to correct the 3d image`
- Contract ID: `A005-CR-VISUAL-CORRECTION-A05`
- Scope executed: measurement-only source gate; exact A04 plinth preservation;
  complete replacement of the rejected A04 base with measured oval C002/C003
  courses and irregular oval C004 rubble; component-local UV correction;
  Blender, textures, LOD0-LOD3, collision, FBXs, final review render,
  independent audit, and visible review
- Technical result: `pass_candidate_pending_flamestrike_visual_review`
- Independent audit: `18/18`; clean FBX re-import: `4/4`
- Final image SHA-256:
...
- Date: 2026-07-20
- Approver for execution: Flamestrike
- Authority statement: full approval and authority to complete the correction
  and do whatever is required within the active A02 correction scope
- Contract ID: `A005-CR-VISUAL-CORRECTION-A02`
- Scope executed: rebuild the A005-only base hierarchy and displayed material
  presentation from the unchanged source/Step 11/Step 14 authorities; preserve
  A01; create Blender, textures, LOD0-LOD3, collision, FBXs, final review
  render, and independent audit; open only the accepted final image
- Technical result:
...
- JSON parse `3/3`; Python compile `2/2`; locked hashes `52/52`; proof hashes
  `6/6`; secret matches and unstaged in-scope differences `0`
- Dependency snapshot commit:
...
- Date: 2026-07-15
- Approver: Flamestrike
- Statement: `I approve the Plan.`
- Scope: fresh-start process structure only
- Result: plan classified `authoritative`; Step 01 remained unauthorized

## Step 01 Contract Approval

- Date: 2026-07-15
- Approver: Flamestrike
- Statement: `Proceed`
- Scope: exact visible Step 01 contract presented during the Core resume
  handshake
- Result: candidate A005 governance-package creation authorized
- Exclusion: Step 01 outputs, Step 02, and production work were not preapproved

## Checkpoint-Metadata Recovery Amendment

- Date: 2026-07-15
- Approver: Flamestrike
- Statement: `approved`
- Scope: inspect and repair stale `Saved/ProjectRecovery/LATEST.md` behavior,
  rerun the checkpoint, and resume Step 01
- Result: manual and local-only checkpoints now share the latest-pointer update

## Step 01 Output Approval

- Date: 2026-07-15
- Approver: Flamestrike
- Statement: `approved`
- Reviewed visibly: complete Step 01 package, project charter, fresh-start
  firewall, and approved checkpoint repair
- Decision: pass
- Result: A005 identity, charter, firewall, reset state, indexes, Step 01 output
  record, and handoff are authoritative
- Exclusion: Step 02 remains unauthorized

## Persistent Review-Visibility Direction

- Date: 2026-07-15
- Authority: Flamestrike
...
## Step 03 Contract Approval

- Date: 2026-07-15
- Approver: Flamestrike
- Statement: `approved`
- Scope: exact visible Step 03 exact-panel-decomposition contract
- Result: lossless six-panel candidate extraction, exact-boundary evidence,
  validation, and candidate Step 03 record creation authorized
- Exclusion: Step 03 output approval, Step 04, component work, interpretation,
  and production work

## Step 03 Candidate Validation

- Date: 2026-07-15
- Technical result: pass
- Source identity: matches approved Step 02 authority
- Panel count: `6`
- Aggregate changed pixels: `0`
- Maximum RGB delta: `0`
- All panels pixel exact: `true`
- Scaling, filtering, rotation, recoloring, cleanup, annotation removal: none
- Interpretation introduced: none
- Output approval: completed after visible Flamestrike boundary review
- Validated-candidate review checkpoint:
  `Saved/ProjectRecovery/20260715-124330/`

## Step 03 Output Approval

- Date: 2026-07-15
- Approver: Flamestrike
- Statement: `approved`
- Reviewed visibly: untouched A02 source, source-only exact-boundary board,
  six lossless panel crops, and Step 03 output record
- Decision: pass
- Result: Step 03 crop formulas and panel images promoted to `authoritative`
- Perspective usage: visual corroboration unless separately calibrated
- Exclusion: Step 04, component work, interpretation, and production work
  remain unauthorized
- Approved pre-closeout checkpoint:
...
## Step 06 Contract Approval

- Date: 2026-07-15
- Approver: Flamestrike
- Statement: `approved`
- Scope: exact visible Step 06 front/back exact-measurement contract
- Result: independent front/back calibration observations, exact pixel-space
  row/contact/feature measurements, measurement contracts, disagreement list,
  unfilled evidence board, validation, and candidate Step 06 record creation
  authorized
- Exclusion: Step 06 output approval, scale selection, averaging, derived
  world-space measurement, interpretation, Step 07, and production work
- Pre-action checkpoint: `Saved/ProjectRecovery/20260715-142939/`

## Step 06 Candidate Validation
...
- Visible row samples: `26`
- Irregular C-004 edge observations: `8`
- Exposed contact sample pixels: `43`
- Appearance landmarks: `32`
...
## Step 06 Output Approval

- Date: 2026-07-15
- Approver: Flamestrike
- Statement: `approved`
- Reviewed visibly: untouched front/back panels, exact unfilled measurement
  evidence board, calibration records, measurement manifests and contracts,
  disagreement list, focused validation, and Step 06 output record
- Decision: pass with blocked disagreements preserved
- Result: source-linked front/back pixel measurements, calibration
...
- Exclusion: consolidated scale, derived world-space contour/contact
  measurements, hidden correspondence, interpretation, Step 07, and
  production work
- Approved pre-closeout checkpoint:
  `Saved/ProjectRecovery/20260715-150643/`

## Step 06 Scoped Content Commit And Push
