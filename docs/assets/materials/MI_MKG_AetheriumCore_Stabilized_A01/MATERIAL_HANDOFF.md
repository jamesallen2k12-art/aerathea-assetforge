# MI_MKG_AetheriumCore_Stabilized_A01 Material Handoff

## Purpose

Author the Aetherium core material variant for `Gnome Armory.png#Core_Stabilized` so Mekgineer devices can share a controlled blue power language without unique shader work per prop.

## Source References

- Production package: `docs/assets/materials/MI_MKG_AetheriumCore_Stabilized_A01/PRODUCTION_PACKAGE.md`
...
- Unreal material path: `/Game/Aerathea/Materials/Props/Mekgineer/Armory/MI_MKG_AetheriumCore_Stabilized_A01`
