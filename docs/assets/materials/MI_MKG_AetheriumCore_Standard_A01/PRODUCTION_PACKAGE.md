# MI_MKG_AetheriumCore_Standard_A01 Production Package

## Art Direction Summary

- Asset name: `MI_MKG_AetheriumCore_Standard_A01`
- Asset type: Material Instance core variant
- Source: `Gnome Armory.png#Core_Standard`
...
Supports balanced-use blue core material variant for default Mekgineer devices. It can also serve future loot, crafting, vendor preview, armory display, equipment socket, and startup-scene review workflows where appropriate.

## Silhouette Notes

Primary read: material-only variant applied to existing core meshes; no unique silhouette. Preserve the large readable forms first; any tiny screws, rivets, wire runs, gauge ticks, and surface scratches must be texture or normal-map detail.

## Scale Notes

shared material instance; intensity tuned for small props and backpacks. Author in centimeters. Keep handles, grips, buttons, and attachment zones usable by compact 3-4 ft gnomes rather than human-scale proportions.
...
Create an original stylized fantasy MMORPG concept image of `MI_MKG_AetheriumCore_Standard_A01`, a material instance core variant for the world of Aerathea. The design should emphasize material-only variant applied to existing core meshes; no unique silhouette, compact gnome-scale ergonomics, brass and dark-iron engineering, dark leather utility details, restrained blue Aetherium accents, curious Mekgineer culture, and balanced-use blue core material variant for default Mekgineer devices. Use hand-painted texture detail, readable shapes, baked-AO-style depth, normal-map-style surface detail, sparing emissive accents, and MMO-friendly production design. Present it as a production asset sheet with front, side, three-quarter view, scale callout, and material callouts on a clean background. Avoid copying any existing franchise and avoid excessive micro-detail that would not translate to a mid-poly Unreal asset.
...
- Docs: `docs/assets/materials/MI_MKG_AetheriumCore_Standard_A01/`
- Source: `Content/Aerathea/Materials/Props/Mekgineer/Armory/`
- Export: `No FBX export; material instance authored in Unreal.`
- Unreal: `/Game/Aerathea/Materials/Props/Mekgineer/Armory/MI_MKG_AetheriumCore_Standard_A01`
