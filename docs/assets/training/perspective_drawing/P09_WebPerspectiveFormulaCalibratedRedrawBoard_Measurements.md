...
- Composition prior: one-point architectural perspective family visible in the source crop
- Solved VP: `(0.461698, 0.553743)`
- VP residual mean/max: `18.641px` / `32.259px`
- Overlay lines: `7` perspective, `5` vertical, `12` horizontal, `8` secondary diagonal
- Displayed perspective lines:
  ...
  - L7: endpoints `(0.948378, 0.052997) -> (0.116996, 0.847623)`; angle `-147.000 deg`; equation `-0.69094619x + -0.72290620y + 0.69359007 = 0`; votes `268`; support `431`; residual `24.180px`
...
- Overlay lines: `7` perspective, `12` vertical, `11` horizontal, `8` secondary diagonal
- Displayed perspective lines:
  ...
  - L7: endpoints `(0.961670, 0.751335) -> (0.099828, 0.493276)`; angle `+167.000 deg`; equation `0.28684435x + -0.95797720y + 0.44391231 = 0`; votes `201`; support `321`; residual `12.416px`
...
- Overlay lines: `7` perspective, `6` vertical, `12` horizontal, `8` secondary diagonal
- Displayed perspective lines:
  ...
  - L7: endpoints `(0.956526, 0.522818) -> (0.032888, 0.699215)`; angle `-172.000 deg`; equation `-0.18759054x + -0.98224732y + 0.69297188 = 0`; votes `324`; support `540`; residual `28.644px`
...
- Overlay lines: `7` perspective, `12` vertical, `9` horizontal, `8` secondary diagonal
- Displayed perspective lines:
  ...
  - L7: endpoints `(0.947858, 0.653832) -> (0.079964, 0.888234)`; angle `-168.000 deg`; equation `-0.26073965x + -0.96540915y + 0.87835913 = 0`; votes `395`; support `599`; residual `17.176px`
...
- Overlay lines: `7` perspective, `11` vertical, `7` horizontal, `8` secondary diagonal
- Displayed perspective lines:
  ...
  - L7: endpoints `(0.762120, 0.030372) -> (0.238495, 0.912108)`; angle `-127.000 deg`; equation `-0.85981505x + -0.51060560y + 0.67078971 = 0`; votes `265`; support `428`; residual `13.633px`
