# SM_MKG_Cogmauler_A01 Modeling Handoff

## Purpose

Create the production DCC source and game-ready asset for `Gnome Armory.png#Rifles_Cogmauler` from the Gnome/Mekgineer armory catalog.

## Source References

- Production package: `docs/assets/props/SM_MKG_Cogmauler_A01/PRODUCTION_PACKAGE.md`
...
Static Mesh compact rifle with this primary read: large reinforced barrel cluster, compact stock, side pressure drum, and single blue receiver window.

## Modeling Constraints

- 90-115 cm long; heavier front silhouette, muzzle socket required.
...
- Object/collection name: `SM_MKG_Cogmauler_A01`.
...
- Blender source: `SourceAssets/Blender/Kits/Mekgineer/Armory/SM_MKG_Cogmauler_A01/SM_MKG_Cogmauler_A01.blend`
- FBX export: `SourceAssets/Exports/Kits/Mekgineer/Armory/SM_MKG_Cogmauler_A01/SM_MKG_Cogmauler_A01.fbx`
