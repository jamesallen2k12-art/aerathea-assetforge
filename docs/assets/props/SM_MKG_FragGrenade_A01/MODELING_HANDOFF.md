# SM_MKG_FragGrenade_A01 Modeling Handoff

## Purpose

Create the production DCC source and game-ready asset for `Gnome Armory.png#Grenades_FragGrenade` from the Gnome/Mekgineer armory catalog.

## Source References

- Production package: `docs/assets/props/SM_MKG_FragGrenade_A01/PRODUCTION_PACKAGE.md`
...
Static Mesh throwable with this primary read: egg-shaped dark-iron casing with large brass bands, pull cap, and no dense small shrapnel geometry.

## Modeling Constraints

- 18-24 cm tall; pivot centered for throw arcs.
...
- Object/collection name: `SM_MKG_FragGrenade_A01`.
...
- Blender source: `SourceAssets/Blender/Kits/Mekgineer/Armory/SM_MKG_FragGrenade_A01/SM_MKG_FragGrenade_A01.blend`
- FBX export: `SourceAssets/Exports/Kits/Mekgineer/Armory/SM_MKG_FragGrenade_A01/SM_MKG_FragGrenade_A01.fbx`
