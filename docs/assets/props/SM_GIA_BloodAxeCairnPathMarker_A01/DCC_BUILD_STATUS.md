...
Final hand-painted textures, final material polish, startup/gameplay placement, final visual approval, waypoint behavior, trail behavior, objective behavior, nav behavior, and pickup behavior remain blocked.
