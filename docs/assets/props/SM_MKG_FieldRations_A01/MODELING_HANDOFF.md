# SM_MKG_FieldRations_A01 Modeling Handoff

## Purpose

Create the production DCC source and game-ready asset for `Gnome Armory.png#Utility_FieldRations` from the Gnome/Mekgineer armory catalog.

## Source References

- Production package: `docs/assets/props/SM_MKG_FieldRations_A01/PRODUCTION_PACKAGE.md`
...
Static Mesh inventory prop with this primary read: compact lunch/tool tin with strapped lid, brass corners, and small stamped gnome mark.

## Modeling Constraints

- 20-30 cm wide; bottom-center pivot.
...
- Object/collection name: `SM_MKG_FieldRations_A01`.
...
- Blender source: `SourceAssets/Blender/Kits/Mekgineer/Armory/SM_MKG_FieldRations_A01/SM_MKG_FieldRations_A01.blend`
- FBX export: `SourceAssets/Exports/Kits/Mekgineer/Armory/SM_MKG_FieldRations_A01/SM_MKG_FieldRations_A01.fbx`
