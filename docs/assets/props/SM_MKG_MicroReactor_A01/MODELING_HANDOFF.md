# SM_MKG_MicroReactor_A01 Modeling Handoff

## Purpose

Create the production DCC source and game-ready asset for `Gnome Armory.png#Gear_MicroReactor` from the Gnome/Mekgineer armory catalog.

## Source References

- Production package: `docs/assets/props/SM_MKG_MicroReactor_A01/PRODUCTION_PACKAGE.md`
...
Static Mesh power module with this primary read: small vertical reactor capsule with brass cage, dark-iron base, and blue core window.

## Modeling Constraints

- 22-35 cm tall; bottom-center pivot for world placement.
...
- Object/collection name: `SM_MKG_MicroReactor_A01`.
...
- Blender source: `SourceAssets/Blender/Kits/Mekgineer/Armory/SM_MKG_MicroReactor_A01/SM_MKG_MicroReactor_A01.blend`
- FBX export: `SourceAssets/Exports/Kits/Mekgineer/Armory/SM_MKG_MicroReactor_A01/SM_MKG_MicroReactor_A01.fbx`
