# SM_MKG_FoldingSaw_A01 Production Package

## Art Direction Summary

- Asset name: `SM_MKG_FoldingSaw_A01`
- Asset type: Static Mesh tool
- Source: `Gnome Armory.png#Tools_FoldingSaw`
...
Supports folding field saw for lumber, salvage, and workshop dressing. It can also serve future loot, crafting, vendor preview, armory display, equipment socket, and startup-scene review workflows where appropriate.

## Silhouette Notes

Primary read: curved saw blade folded into a thick brass/dark-iron handle with one visible hinge. Preserve the large readable forms first; any tiny screws, rivets, wire runs, gauge ticks, and surface scratches must be texture or normal-map detail.

## Scale Notes

35-55 cm long; hinge should read as a large simple form. Author in centimeters. Keep handles, grips, buttons, and attachment zones usable by compact 3-4 ft gnomes rather than human-scale proportions.
...
- `T_MKG_FoldingSaw_A01_BC`
- `T_MKG_FoldingSaw_A01_N`
- `T_MKG_FoldingSaw_A01_ORM`
- `T_MKG_FoldingSaw_A01_E` only for the explicit blue Aetherium lens/core/window
...
- Unreal path: `/Game/Aerathea/Props/Mekgineer/Armory/SM_MKG_FoldingSaw_A01`
...
- Docs: `docs/assets/props/SM_MKG_FoldingSaw_A01/`
- Source: `SourceAssets/Blender/Kits/Mekgineer/Armory/SM_MKG_FoldingSaw_A01/`
- Export: `SourceAssets/Exports/Kits/Mekgineer/Armory/SM_MKG_FoldingSaw_A01/`
- Unreal: `/Game/Aerathea/Props/Mekgineer/Armory/SM_MKG_FoldingSaw_A01`
