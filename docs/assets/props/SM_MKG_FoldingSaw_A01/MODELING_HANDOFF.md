# SM_MKG_FoldingSaw_A01 Modeling Handoff

## Purpose

Create the production DCC source and game-ready asset for `Gnome Armory.png#Tools_FoldingSaw` from the Gnome/Mekgineer armory catalog.

## Source References

- Production package: `docs/assets/props/SM_MKG_FoldingSaw_A01/PRODUCTION_PACKAGE.md`
...
Static Mesh tool with this primary read: curved saw blade folded into a thick brass/dark-iron handle with one visible hinge.

## Modeling Constraints

- 35-55 cm long; hinge should read as a large simple form.
...
- Object/collection name: `SM_MKG_FoldingSaw_A01`.
...
- Blender source: `SourceAssets/Blender/Kits/Mekgineer/Armory/SM_MKG_FoldingSaw_A01/SM_MKG_FoldingSaw_A01.blend`
- FBX export: `SourceAssets/Exports/Kits/Mekgineer/Armory/SM_MKG_FoldingSaw_A01/SM_MKG_FoldingSaw_A01.fbx`
