# SM_MKG_MedKit_A01 Modeling Handoff

## Purpose

Create the production DCC source and game-ready asset for `Gnome Armory.png#Utility_MedKit` from the Gnome/Mekgineer armory catalog.

## Source References

- Production package: `docs/assets/props/SM_MKG_MedKit_A01/PRODUCTION_PACKAGE.md`
...
Static Mesh inventory prop with this primary read: boxy satchel case with large front cross mark, latch blocks, leather handle, and small blue vial.

## Modeling Constraints

- 24-36 cm wide; bottom-center pivot.
...
- Object/collection name: `SM_MKG_MedKit_A01`.
...
- Blender source: `SourceAssets/Blender/Kits/Mekgineer/Armory/SM_MKG_MedKit_A01/SM_MKG_MedKit_A01.blend`
- FBX export: `SourceAssets/Exports/Kits/Mekgineer/Armory/SM_MKG_MedKit_A01/SM_MKG_MedKit_A01.fbx`
