...
Authored UVs, final hand-painted textures, material instances, collision proxy, Unreal import, startup placement, final visual approval, route scripting, encounter behavior, lane behavior, and pathfinding behavior remain blocked.
