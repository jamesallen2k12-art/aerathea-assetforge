# SM_MKG_WeldingTorch_A01 Production Package

## Art Direction Summary

- Asset name: `SM_MKG_WeldingTorch_A01`
- Asset type: Static Mesh tool
- Source: `Gnome Armory.png#Tools_WeldingTorch`
...
Supports workshop repair tool and future VFX socket test asset. It can also serve future loot, crafting, vendor preview, armory display, equipment socket, and startup-scene review workflows where appropriate.

## Silhouette Notes

Primary read: short torch cylinder, angled nozzle, blue fuel vial, and protective brass collar. Preserve the large readable forms first; any tiny screws, rivets, wire runs, gauge ticks, and surface scratches must be texture or normal-map detail.

## Scale Notes

35-55 cm long; nozzle socket named `socket_flame`. Author in centimeters. Keep handles, grips, buttons, and attachment zones usable by compact 3-4 ft gnomes rather than human-scale proportions.
...
Create an original stylized fantasy MMORPG concept image of `SM_MKG_WeldingTorch_A01`, a static mesh tool for the world of Aerathea. The design should emphasize short torch cylinder, angled nozzle, blue fuel vial, and protective brass collar, compact gnome-scale ergonomics, brass and dark-iron engineering, dark leather utility details, restrained blue Aetherium accents, curious Mekgineer culture, and workshop repair tool and future VFX socket test asset. Use hand-painted texture detail, readable shapes, baked-AO-style depth, normal-map-style surface detail, sparing emissive accents, and MMO-friendly production design. Present it as a production asset sheet with front, side, three-quarter view, scale callout, and material callouts on a clean background. Avoid copying any existing franchise and avoid excessive micro-detail that would not translate to a mid-poly Unreal asset.
...
- `T_MKG_WeldingTorch_A01_BC`
- `T_MKG_WeldingTorch_A01_N`
- `T_MKG_WeldingTorch_A01_ORM`
- `T_MKG_WeldingTorch_A01_E` only for the explicit blue Aetherium lens/core/window
- Prefer one material slot; use two only when a backpack, rifle, shield, or configuration needs a shared core material split.

## Triangle Budget

LOD0 1.2k-2.8k tris, one material slot.
...
- Unreal path: `/Game/Aerathea/Props/Mekgineer/Armory/SM_MKG_WeldingTorch_A01`
...
- Docs: `docs/assets/props/SM_MKG_WeldingTorch_A01/`
- Source: `SourceAssets/Blender/Kits/Mekgineer/Armory/SM_MKG_WeldingTorch_A01/`
- Export: `SourceAssets/Exports/Kits/Mekgineer/Armory/SM_MKG_WeldingTorch_A01/`
- Unreal: `/Game/Aerathea/Props/Mekgineer/Armory/SM_MKG_WeldingTorch_A01`
