# SM_MKG_WeldingTorch_A01 Modeling Handoff

## Purpose

Create the production DCC source and game-ready asset for `Gnome Armory.png#Tools_WeldingTorch` from the Gnome/Mekgineer armory catalog.

## Source References

- Production package: `docs/assets/props/SM_MKG_WeldingTorch_A01/PRODUCTION_PACKAGE.md`
...
Static Mesh tool with this primary read: short torch cylinder, angled nozzle, blue fuel vial, and protective brass collar.

## Modeling Constraints

- 35-55 cm long; nozzle socket named `socket_flame`.
...
- Object/collection name: `SM_MKG_WeldingTorch_A01`.
...
- Blender source: `SourceAssets/Blender/Kits/Mekgineer/Armory/SM_MKG_WeldingTorch_A01/SM_MKG_WeldingTorch_A01.blend`
- FBX export: `SourceAssets/Exports/Kits/Mekgineer/Armory/SM_MKG_WeldingTorch_A01/SM_MKG_WeldingTorch_A01.fbx`
