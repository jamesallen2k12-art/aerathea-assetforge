# SM_MKG_Geargrinder_A01 Modeling Handoff

## Purpose

Create the production DCC source and game-ready asset for `Gnome Armory.png#Rifles_Geargrinder` from the Gnome/Mekgineer armory catalog.

## Source References

- Production package: `docs/assets/props/SM_MKG_Geargrinder_A01/PRODUCTION_PACKAGE.md`
...
Static Mesh compact rifle with this primary read: wide multi-cylinder muzzle, layered dark-iron receiver, brass braces, and compact grip/stock.

## Modeling Constraints

- 90-115 cm long; muzzle socket at barrel centerline.
...
- Object/collection name: `SM_MKG_Geargrinder_A01`.
...
- Blender source: `SourceAssets/Blender/Kits/Mekgineer/Armory/SM_MKG_Geargrinder_A01/SM_MKG_Geargrinder_A01.blend`
- FBX export: `SourceAssets/Exports/Kits/Mekgineer/Armory/SM_MKG_Geargrinder_A01/SM_MKG_Geargrinder_A01.fbx`
