# SM_MKG_GrappleHook_A01 Modeling Handoff

## Purpose

Create the production DCC source and game-ready asset for `Gnome Armory.png#Tools_GrappleHook` from the Gnome/Mekgineer armory catalog.

## Source References

- Production package: `docs/assets/props/SM_MKG_GrappleHook_A01/PRODUCTION_PACKAGE.md`
...
Static Mesh tool with this primary read: large hook head with three readable claws, short launcher handle, and rear cable socket.

## Modeling Constraints

- 45-70 cm long; hook tip forward, cable socket named `socket_cable`.
...
- Object/collection name: `SM_MKG_GrappleHook_A01`.
...
- Blender source: `SourceAssets/Blender/Kits/Mekgineer/Armory/SM_MKG_GrappleHook_A01/SM_MKG_GrappleHook_A01.blend`
- FBX export: `SourceAssets/Exports/Kits/Mekgineer/Armory/SM_MKG_GrappleHook_A01/SM_MKG_GrappleHook_A01.fbx`
