# SM_MKG_HeavyPistol_A01 Modeling Handoff

## Purpose

Create the production DCC source and game-ready asset for `Gnome Armory.png#Pistols_HeavyPistol` from the Gnome/Mekgineer armory catalog.

## Source References

- Production package: `docs/assets/props/SM_MKG_HeavyPistol_A01/PRODUCTION_PACKAGE.md`
...
Static Mesh pistol with this primary read: wide double-band barrel, reinforced square receiver, chunky hammer block, and low blue chamber light.

## Modeling Constraints

- 35-48 cm long; pivot at grip center.
...
- Object/collection name: `SM_MKG_HeavyPistol_A01`.
...
- Blender source: `SourceAssets/Blender/Kits/Mekgineer/Armory/SM_MKG_HeavyPistol_A01/SM_MKG_HeavyPistol_A01.blend`
- FBX export: `SourceAssets/Exports/Kits/Mekgineer/Armory/SM_MKG_HeavyPistol_A01/SM_MKG_HeavyPistol_A01.fbx`
