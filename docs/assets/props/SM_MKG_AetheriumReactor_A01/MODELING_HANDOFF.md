# SM_MKG_AetheriumReactor_A01 Modeling Handoff

## Purpose

Create the production DCC source and game-ready asset for `Gnome Armory.png#Backpack_AetheriumReactor` from the Gnome/Mekgineer armory catalog.

## Source References

- Production package: `docs/assets/props/SM_MKG_AetheriumReactor_A01/PRODUCTION_PACKAGE.md`
...
Static Mesh backpack/power module with this primary read: round central blue reactor framed by brass/dark-iron cage, compact side tanks, and back straps.

## Modeling Constraints

- 45-70 cm tall; reactor core visible from rear three-quarter view.
...
- Object/collection name: `SM_MKG_AetheriumReactor_A01`.
...
- Blender source: `SourceAssets/Blender/Kits/Mekgineer/Armory/SM_MKG_AetheriumReactor_A01/SM_MKG_AetheriumReactor_A01.blend`
- FBX export: `SourceAssets/Exports/Kits/Mekgineer/Armory/SM_MKG_AetheriumReactor_A01/SM_MKG_AetheriumReactor_A01.fbx`
