# SM_MKG_AetherRifle_A01 Modeling Handoff

## Purpose

Create the production DCC source and game-ready asset for `Gnome Armory.png#Rifles_AetherRifle` from the Gnome/Mekgineer armory catalog.

## Source References

- Production package: `docs/assets/props/SM_MKG_AetherRifle_A01/PRODUCTION_PACKAGE.md`
...
Static Mesh compact rifle with this primary read: clean compact rifle body, cylindrical barrel, large blue chamber, brass frame, and short stock.

## Modeling Constraints

- 85-110 cm long; grip pivot and muzzle socket required.
...
- Object/collection name: `SM_MKG_AetherRifle_A01`.
...
- Blender source: `SourceAssets/Blender/Kits/Mekgineer/Armory/SM_MKG_AetherRifle_A01/SM_MKG_AetherRifle_A01.blend`
- FBX export: `SourceAssets/Exports/Kits/Mekgineer/Armory/SM_MKG_AetherRifle_A01/SM_MKG_AetherRifle_A01.fbx`
