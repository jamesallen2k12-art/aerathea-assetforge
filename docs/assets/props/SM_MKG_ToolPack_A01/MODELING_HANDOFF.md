# SM_MKG_ToolPack_A01 Modeling Handoff

## Purpose

Create the production DCC source and game-ready asset for `Gnome Armory.png#Backpack_ToolPack` from the Gnome/Mekgineer armory catalog.

## Source References

- Production package: `docs/assets/props/SM_MKG_ToolPack_A01/PRODUCTION_PACKAGE.md`
...
Static Mesh backpack with this primary read: stacked tool pack with top handle, side pouches, visible large wrench/saw silhouettes, and leather straps.
...
- Object/collection name: `SM_MKG_ToolPack_A01`.
...
- Blender source: `SourceAssets/Blender/Kits/Mekgineer/Armory/SM_MKG_ToolPack_A01/SM_MKG_ToolPack_A01.blend`
- FBX export: `SourceAssets/Exports/Kits/Mekgineer/Armory/SM_MKG_ToolPack_A01/SM_MKG_ToolPack_A01.fbx`
