# SM_MKG_SpikeDrill_A01 Production Package

## Art Direction Summary

- Asset name: `SM_MKG_SpikeDrill_A01`
- Asset type: Static Mesh one-handed weapon/tool
- Source: `Gnome Armory.png#Weapons_SpikeDrill`
...
- Status: First-pass DCC review source generated/exported/imported to Unreal, material instances and LOD0-LOD3 generated, placed in the startup scene, and validation passing; final art mesh, UVs, authored textures, tuned collision, and socket fit remain open

Create an original Aerathea gnome/Mekgineer child asset from the armory catalog. This package keeps the compact, rugged, Aetherium-powered language established by `KIT_MKG_Armory_A01` and the completed first-pass armory child props.

## Gameplay Purpose

Supports drill-mace tool weapon for construction, salvage, and close-range combat reads. It can also serve future loot, crafting, vendor preview, armory display, equipment socket, and startup-scene review workflows where appropriate.

## Silhouette Notes

Primary read: short drill spike, chunky cylindrical motor head, braced brass frame, and leather-wrapped handle. Preserve the large readable forms first; any tiny screws, rivets, wire runs, gauge ticks, and surface scratches must be texture or normal-map detail.

## Scale Notes

45-65 cm total length; drill axis forward from hand grip. Author in centimeters. Keep handles, grips, buttons, and attachment zones usable by compact 3-4 ft gnomes rather than human-scale proportions.
...
Create an original stylized fantasy MMORPG concept image of `SM_MKG_SpikeDrill_A01`, a static mesh one-handed weapon/tool for the world of Aerathea. The design should emphasize short drill spike, chunky cylindrical motor head, braced brass frame, and leather-wrapped handle, compact gnome-scale ergonomics, brass and dark-iron engineering, dark leather utility details, restrained blue Aetherium accents, curious Mekgineer culture, and drill-mace tool weapon for construction, salvage, and close-range combat reads. Use hand-painted texture detail, readable shapes, baked-AO-style depth, normal-map-style surface detail, sparing emissive accents, and MMO-friendly production design. Present it as a production asset sheet with front, side, three-quarter view, scale callout, and material callouts on a clean background. Avoid copying any existing franchise and avoid excessive micro-detail that would not translate to a mid-poly Unreal asset.
...
- `T_MKG_SpikeDrill_A01_BC`
- `T_MKG_SpikeDrill_A01_N`
- `T_MKG_SpikeDrill_A01_ORM`
- `T_MKG_SpikeDrill_A01_E` only for the explicit blue Aetherium lens/core/window
...
- Unreal path: `/Game/Aerathea/Weapons/Mekgineer/SM_MKG_SpikeDrill_A01`
- Current startup actor: `AET_PROD_MKG_SpikeDrill_A01` in `L_Aerathea_Startup`
...
- Docs: `docs/assets/props/SM_MKG_SpikeDrill_A01/`
- Source: `SourceAssets/Blender/Kits/Mekgineer/Armory/SM_MKG_SpikeDrill_A01/`
- Export: `SourceAssets/Exports/Kits/Mekgineer/Armory/SM_MKG_SpikeDrill_A01/`
- Unreal: `/Game/Aerathea/Weapons/Mekgineer/SM_MKG_SpikeDrill_A01`
