# SM_MKG_SpikeDrill_A01 Build And Import Status
...
- Unreal placement status: `AET_PROD_MKG_SpikeDrill_A01` exists in `L_Aerathea_Startup`
...
- Production package:
  - `docs/assets/props/SM_MKG_SpikeDrill_A01/PRODUCTION_PACKAGE.md`
- Modeling handoff:
  - `docs/assets/props/SM_MKG_SpikeDrill_A01/MODELING_HANDOFF.md`
- Blender source/export:
  - `SourceAssets/Blender/Kits/Mekgineer/Armory/SM_MKG_SpikeDrill_A01/SM_MKG_SpikeDrill_A01.blend`
  - `SourceAssets/Exports/Kits/Mekgineer/Armory/SM_MKG_SpikeDrill_A01/SM_MKG_SpikeDrill_A01.fbx`
- Unreal asset:
...
The Spike Drill is imported for startup validation and production review. Do not mark it final until art review, UVs, textures, tuned LODs, socket inspection, and collision review are complete.
