# SM_MKG_SpikeDrill_A01 Modeling Handoff

## Purpose

Create the production DCC source and game-ready asset for `Gnome Armory.png#Weapons_SpikeDrill` from the Gnome/Mekgineer armory catalog.

## Source References

- Production package: `docs/assets/props/SM_MKG_SpikeDrill_A01/PRODUCTION_PACKAGE.md`
...
Static Mesh one-handed weapon/tool with this primary read: short drill spike, chunky cylindrical motor head, braced brass frame, and leather-wrapped handle.

## Modeling Constraints

- 45-65 cm total length; drill axis forward from hand grip.
...
- Object/collection name: `SM_MKG_SpikeDrill_A01`.
...
- Blender source: `SourceAssets/Blender/Kits/Mekgineer/Armory/SM_MKG_SpikeDrill_A01/SM_MKG_SpikeDrill_A01.blend`
- FBX export: `SourceAssets/Exports/Kits/Mekgineer/Armory/SM_MKG_SpikeDrill_A01/SM_MKG_SpikeDrill_A01.fbx`
