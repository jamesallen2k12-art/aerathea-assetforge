# SM_MKG_RatchetCleaver_A01 Modeling Handoff

## Purpose

Create the production DCC source and game-ready asset for `Gnome Armory.png#Weapons_RatchetCleaver` from the Gnome/Mekgineer armory catalog.

## Source References

- Production package: `docs/assets/props/SM_MKG_RatchetCleaver_A01/PRODUCTION_PACKAGE.md`
...
Static Mesh one-handed weapon with this primary read: wide cleaver blade with a compact reinforced spine, oversized gnome grip, and one blue calibration inset near the guard.

## Modeling Constraints

- 45-60 cm total length; pivot centered in the grip for `hand_r_weapon` socketing.
...
- Object/collection name: `SM_MKG_RatchetCleaver_A01`.
