# SM_MKG_RatchetCleaver_A01 Build And Import Status
...
- Unreal placement status: `AET_PROD_MKG_RatchetCleaver_A01` exists in `L_Aerathea_Startup`
- Validation: `Tools/Unreal/validate_startup_scene.py` passes through `UnrealEditor-Cmd`

## Completed Prerequisites

- Production package:
  - `docs/assets/props/SM_MKG_RatchetCleaver_A01/PRODUCTION_PACKAGE.md`
- Modeling handoff:
  - `docs/assets/props/SM_MKG_RatchetCleaver_A01/MODELING_HANDOFF.md`
- Blender source/export:
  - `SourceAssets/Blender/Kits/Mekgineer/Armory/SM_MKG_RatchetCleaver_A01/SM_MKG_RatchetCleaver_A01.blend`
  - `SourceAssets/Exports/Kits/Mekgineer/Armory/SM_MKG_RatchetCleaver_A01/SM_MKG_RatchetCleaver_A01.fbx`
- Unreal asset:
...
The ratchet cleaver is imported for startup validation and production review. Do not mark it final until art review, UVs, textures, LODs, and equipped socket inspection are complete.
