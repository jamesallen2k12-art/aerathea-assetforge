# SM_MKG_RatchetCleaver_A01 Production Package

## Art Direction Summary

- Asset name: `SM_MKG_RatchetCleaver_A01`
- Asset type: Static Mesh one-handed weapon
- Source: `Gnome Armory.png#Weapons_RatchetCleaver`
...
- Blender source: `SourceAssets/Blender/Kits/Mekgineer/Armory/SM_MKG_RatchetCleaver_A01/SM_MKG_RatchetCleaver_A01.blend`
- FBX export: `SourceAssets/Exports/Kits/Mekgineer/Armory/SM_MKG_RatchetCleaver_A01/SM_MKG_RatchetCleaver_A01.fbx`
- Unreal asset: `/Game/Aerathea/Weapons/Mekgineer/SM_MKG_RatchetCleaver_A01`
- Startup actor: `AET_PROD_MKG_RatchetCleaver_A01`
...
- Remaining production work: approved art-model pass, final UV unwrap, authored BC/N/ORM/E texture set, final material slot cleanup, equipped socket/pivot inspection, and tangent/normal cleanup.
...
Supports broad chopping tool-weapon for Mekgineer melee identity. It can also serve future loot, crafting, vendor preview, armory display, equipment socket, and startup-scene review workflows where appropriate.

## Silhouette Notes

Primary read: wide cleaver blade with a compact reinforced spine, oversized gnome grip, and one blue calibration inset near the guard. Preserve the large readable forms first; any tiny screws, rivets, wire runs, gauge ticks, and surface scratches must be texture or normal-map detail.

## Scale Notes

45-60 cm total length; pivot centered in the grip for `hand_r_weapon` socketing. Author in centimeters. Keep handles, grips, buttons, and attachment zones usable by compact 3-4 ft gnomes rather than human-scale proportions.
...
Create an original stylized fantasy MMORPG concept image of `SM_MKG_RatchetCleaver_A01`, a static mesh one-handed weapon for the world of Aerathea. The design should emphasize wide cleaver blade with a compact reinforced spine, oversized gnome grip, and one blue calibration inset near the guard, compact gnome-scale ergonomics, brass and dark-iron engineering, dark leather utility details, restrained blue Aetherium accents, curious Mekgineer culture, and broad chopping tool-weapon for Mekgineer melee identity. Use hand-painted texture detail, readable shapes, baked-AO-style depth, normal-map-style surface detail, sparing emissive accents, and MMO-friendly production design. Present it as a production asset sheet with front, side, three-quarter view, scale callout, and material callouts on a clean background. Avoid copying any existing franchise and avoid excessive micro-detail that would not translate to a mid-poly Unreal asset.
...
- `T_MKG_RatchetCleaver_A01_BC`
- `T_MKG_RatchetCleaver_A01_N`
- `T_MKG_RatchetCleaver_A01_ORM`
- `T_MKG_RatchetCleaver_A01_E` only for the explicit blue Aetherium lens/core/window
- Prefer one material slot; use two only when a backpack, rifle, shield, or configuration needs a shared core material split.

## Triangle Budget

LOD0 1.4k-2.8k tris, one material slot.
...
- Unreal path: `/Game/Aerathea/Weapons/Mekgineer/SM_MKG_RatchetCleaver_A01`
...
- Docs: `docs/assets/props/SM_MKG_RatchetCleaver_A01/`
- Source: `SourceAssets/Blender/Kits/Mekgineer/Armory/SM_MKG_RatchetCleaver_A01/`
- Export: `SourceAssets/Exports/Kits/Mekgineer/Armory/SM_MKG_RatchetCleaver_A01/`
- Unreal: `/Game/Aerathea/Weapons/Mekgineer/SM_MKG_RatchetCleaver_A01`
