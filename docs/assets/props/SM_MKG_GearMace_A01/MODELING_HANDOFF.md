# SM_MKG_GearMace_A01 Modeling Handoff

## Purpose

Create the production DCC source and game-ready asset for `Gnome Armory.png#Weapons_GearMace` from the Gnome/Mekgineer armory catalog.

## Source References

- Production package: `docs/assets/props/SM_MKG_GearMace_A01/PRODUCTION_PACKAGE.md`
...
Static Mesh one-handed weapon with this primary read: round heavy gear-like mace head with blunt teeth, short shaft, and central Aetherium cap.

## Modeling Constraints

- 45-60 cm total length; head no wider than 24 cm for gnome handling.
...
- Object/collection name: `SM_MKG_GearMace_A01`.
