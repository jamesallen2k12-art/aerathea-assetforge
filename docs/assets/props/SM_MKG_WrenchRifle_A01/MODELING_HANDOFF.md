# SM_MKG_WrenchRifle_A01 Modeling Handoff

## Purpose

Create the production DCC source and game-ready asset for `Gnome Armory.png#Rifles_WrenchRifle` from the Gnome/Mekgineer armory catalog.

## Source References

- Production package: `docs/assets/props/SM_MKG_WrenchRifle_A01/PRODUCTION_PACKAGE.md`
...
Static Mesh compact rifle with this primary read: short rifle frame with wrench-like front jaw, compact shoulder brace, and central blue gauge.

## Modeling Constraints

- 85-105 cm long; pivot at main grip, muzzle socket required.
...
- Object/collection name: `SM_MKG_WrenchRifle_A01`.
...
- Blender source: `SourceAssets/Blender/Kits/Mekgineer/Armory/SM_MKG_WrenchRifle_A01/SM_MKG_WrenchRifle_A01.blend`
- FBX export: `SourceAssets/Exports/Kits/Mekgineer/Armory/SM_MKG_WrenchRifle_A01/SM_MKG_WrenchRifle_A01.fbx`
