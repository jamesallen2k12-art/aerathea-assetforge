# SM_MKG_AetherPack_A01 Production Package

## Art Direction Summary

- Asset name: `SM_MKG_AetherPack_A01`
- Asset type: Static Mesh backpack/equipment
- Source: `Gnome Armory.png#Utility_AetherPack`
...
Supports compact powered backpack for tools, traversal devices, and character silhouette testing. It can also serve future loot, crafting, vendor preview, armory display, equipment socket, and startup-scene review workflows where appropriate.

## Silhouette Notes

Primary read: rectangular backpack with rounded side tanks, brass frame, dark leather straps, and one blue rear core. Preserve the large readable forms first; any tiny screws, rivets, wire runs, gauge ticks, and surface scratches must be texture or normal-map detail.

## Scale Notes

45-65 cm tall; `back_pack` attachment pivot required. Author in centimeters. Keep handles, grips, buttons, and attachment zones usable by compact 3-4 ft gnomes rather than human-scale proportions.
...
Create an original stylized fantasy MMORPG concept image of `SM_MKG_AetherPack_A01`, a static mesh backpack/equipment for the world of Aerathea. The design should emphasize rectangular backpack with rounded side tanks, brass frame, dark leather straps, and one blue rear core, compact gnome-scale ergonomics, brass and dark-iron engineering, dark leather utility details, restrained blue Aetherium accents, curious Mekgineer culture, and compact powered backpack for tools, traversal devices, and character silhouette testing. Use hand-painted texture detail, readable shapes, baked-AO-style depth, normal-map-style surface detail, sparing emissive accents, and MMO-friendly production design. Present it as a production asset sheet with front, side, three-quarter view, scale callout, and material callouts on a clean background. Avoid copying any existing franchise and avoid excessive micro-detail that would not translate to a mid-poly Unreal asset.
...
- `T_MKG_AetherPack_A01_BC`
- `T_MKG_AetherPack_A01_N`
- `T_MKG_AetherPack_A01_ORM`
- `T_MKG_AetherPack_A01_E` only for the explicit blue Aetherium lens/core/window
...
- Unreal path: `/Game/Aerathea/Props/Mekgineer/Armory/SM_MKG_AetherPack_A01`
...
- Docs: `docs/assets/props/SM_MKG_AetherPack_A01/`
- Source: `SourceAssets/Blender/Kits/Mekgineer/Armory/SM_MKG_AetherPack_A01/`
- Export: `SourceAssets/Exports/Kits/Mekgineer/Armory/SM_MKG_AetherPack_A01/`
- Unreal: `/Game/Aerathea/Props/Mekgineer/Armory/SM_MKG_AetherPack_A01`
