# SM_MKG_AetherPack_A01 Modeling Handoff

## Purpose

Create the production DCC source and game-ready asset for `Gnome Armory.png#Utility_AetherPack` from the Gnome/Mekgineer armory catalog.

## Source References

- Production package: `docs/assets/props/SM_MKG_AetherPack_A01/PRODUCTION_PACKAGE.md`
...
Static Mesh backpack/equipment with this primary read: rectangular backpack with rounded side tanks, brass frame, dark leather straps, and one blue rear core.

## Modeling Constraints

- 45-65 cm tall; `back_pack` attachment pivot required.
...
- Object/collection name: `SM_MKG_AetherPack_A01`.
...
- Blender source: `SourceAssets/Blender/Kits/Mekgineer/Armory/SM_MKG_AetherPack_A01/SM_MKG_AetherPack_A01.blend`
- FBX export: `SourceAssets/Exports/Kits/Mekgineer/Armory/SM_MKG_AetherPack_A01/SM_MKG_AetherPack_A01.fbx`
