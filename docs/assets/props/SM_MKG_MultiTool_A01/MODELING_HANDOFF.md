# SM_MKG_MultiTool_A01 Modeling Handoff

## Purpose

Create the production DCC source and game-ready asset for `Gnome Armory.png#Tools_MultiTool` from the Gnome/Mekgineer armory catalog.

## Source References

- Production package: `docs/assets/props/SM_MKG_MultiTool_A01/PRODUCTION_PACKAGE.md`
...
Static Mesh tool with this primary read: flat folded handle with one large wrench jaw and one screw-driver blade exposed as simple forms.

## Modeling Constraints

- 28-42 cm long; pivot at handle center.
...
- Object/collection name: `SM_MKG_MultiTool_A01`.
...
- Blender source: `SourceAssets/Blender/Kits/Mekgineer/Armory/SM_MKG_MultiTool_A01/SM_MKG_MultiTool_A01.blend`
- FBX export: `SourceAssets/Exports/Kits/Mekgineer/Armory/SM_MKG_MultiTool_A01/SM_MKG_MultiTool_A01.fbx`
