# SM_MKG_LinkedToolRig_A01 Modeling Handoff

## Purpose

Create the production DCC source and game-ready asset for `Gnome Armory.png#Gear_LinkedToolRig` from the Gnome/Mekgineer armory catalog.

## Source References

- Production package: `docs/assets/props/SM_MKG_LinkedToolRig_A01/PRODUCTION_PACKAGE.md`
...
Static Mesh gear rig with this primary read: rectangular frame with two large cylindrical tool sockets, top clamps, and visible central blue regulator.

## Modeling Constraints

- 35-50 cm wide; rear attachment plane aligned for `back_pack` or `belt_tool_r` socket.
...
- Object/collection name: `SM_MKG_LinkedToolRig_A01`.
...
- Blender source: `SourceAssets/Blender/Kits/Mekgineer/Armory/SM_MKG_LinkedToolRig_A01/SM_MKG_LinkedToolRig_A01.blend`
- FBX export: `SourceAssets/Exports/Kits/Mekgineer/Armory/SM_MKG_LinkedToolRig_A01/SM_MKG_LinkedToolRig_A01.fbx`
