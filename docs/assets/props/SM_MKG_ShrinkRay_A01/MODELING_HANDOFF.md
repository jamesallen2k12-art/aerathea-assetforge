# SM_MKG_ShrinkRay_A01 Modeling Handoff

## Purpose

Create the production DCC source and game-ready asset for `Gnome Armory.png#Utility_ShrinkRay` from the Gnome/Mekgineer armory catalog.

## Source References

- Production package: `docs/assets/props/SM_MKG_ShrinkRay_A01/PRODUCTION_PACKAGE.md`
...
Static Mesh device/tool weapon with this primary read: short ray-device barrel, blue lens, brass ring frame, stockless grip, and sturdy tripod-like lower brace.

## Modeling Constraints

- 45-70 cm long; muzzle socket named `socket_beam`.
...
- Object/collection name: `SM_MKG_ShrinkRay_A01`.
...
- Blender source: `SourceAssets/Blender/Kits/Mekgineer/Armory/SM_MKG_ShrinkRay_A01/SM_MKG_ShrinkRay_A01.blend`
- FBX export: `SourceAssets/Exports/Kits/Mekgineer/Armory/SM_MKG_ShrinkRay_A01/SM_MKG_ShrinkRay_A01.fbx`
