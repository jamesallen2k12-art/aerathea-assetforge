...
Final hand-painted textures, material instances, Unreal import, startup placement, final visual approval, waypoint behavior, nav route behavior, and encounter behavior remain blocked.
