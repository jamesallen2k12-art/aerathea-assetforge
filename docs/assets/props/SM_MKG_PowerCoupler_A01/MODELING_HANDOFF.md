# SM_MKG_PowerCoupler_A01 Modeling Handoff

## Purpose

Create the production DCC source and game-ready asset for `Gnome Armory.png#Gear_PowerCoupler` from the Gnome/Mekgineer armory catalog.

## Source References

- Production package: `docs/assets/props/SM_MKG_PowerCoupler_A01/PRODUCTION_PACKAGE.md`
...
Static Mesh power module with this primary read: boxy dual-port coupling body with circular pressure plate, side sockets, and restrained blue core.

## Modeling Constraints

- 30-45 cm wide; world prop pivot at bottom center, attachment pivot variant at rear mount.
...
- Object/collection name: `SM_MKG_PowerCoupler_A01`.
...
- Blender source: `SourceAssets/Blender/Kits/Mekgineer/Armory/SM_MKG_PowerCoupler_A01/SM_MKG_PowerCoupler_A01.blend`
- FBX export: `SourceAssets/Exports/Kits/Mekgineer/Armory/SM_MKG_PowerCoupler_A01/SM_MKG_PowerCoupler_A01.fbx`
