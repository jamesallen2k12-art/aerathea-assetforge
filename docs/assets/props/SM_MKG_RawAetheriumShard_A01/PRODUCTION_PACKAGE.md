# SM_MKG_RawAetheriumShard_A01 Production Package

## Art Direction Summary

- Asset name: `SM_MKG_RawAetheriumShard_A01`
- Asset type: Static Mesh raw material prop
- Source: `Gnome Armory.png#Core_RawShard`
...
Supports unrefined crystal resource prop for crafting, loot, and material-source displays. It can also serve future loot, crafting, vendor preview, armory display, equipment socket, and startup-scene review workflows where appropriate.

## Silhouette Notes

Primary read: cluster of large angular blue shards with a simple dark base or no base, readable as raw resource not finished machinery. Preserve the large readable forms first; any tiny screws, rivets, wire runs, gauge ticks, and surface scratches must be texture or normal-map detail.

## Scale Notes

18-35 cm tall; bottom-center pivot for world placement. Author in centimeters. Keep handles, grips, buttons, and attachment zones usable by compact 3-4 ft gnomes rather than human-scale proportions.
...
Create an original stylized fantasy MMORPG concept image of `SM_MKG_RawAetheriumShard_A01`, a static mesh raw material prop for the world of Aerathea. The design should emphasize cluster of large angular blue shards with a simple dark base or no base, readable as raw resource not finished machinery, compact gnome-scale ergonomics, brass and dark-iron engineering, dark leather utility details, restrained blue Aetherium accents, curious Mekgineer culture, and unrefined crystal resource prop for crafting, loot, and material-source displays. Use hand-painted texture detail, readable shapes, baked-AO-style depth, normal-map-style surface detail, sparing emissive accents, and MMO-friendly production design. Present it as a production asset sheet with front, side, three-quarter view, scale callout, and material callouts on a clean background. Avoid copying any existing franchise and avoid excessive micro-detail that would not translate to a mid-poly Unreal asset.
...
- `T_MKG_RawAetheriumShard_A01_BC`
- `T_MKG_RawAetheriumShard_A01_N`
- `T_MKG_RawAetheriumShard_A01_ORM`
- `T_MKG_RawAetheriumShard_A01_E` only for the explicit blue Aetherium lens/core/window
- Prefer one material slot; use two only when a backpack, rifle, shield, or configuration needs a shared core material split.

## Triangle Budget

LOD0 800-2.5k tris, one material slot.
...
- Unreal path: `/Game/Aerathea/Props/Mekgineer/Armory/SM_MKG_RawAetheriumShard_A01`
...
- Docs: `docs/assets/props/SM_MKG_RawAetheriumShard_A01/`
- Source: `SourceAssets/Blender/Kits/Mekgineer/Armory/SM_MKG_RawAetheriumShard_A01/`
- Export: `SourceAssets/Exports/Kits/Mekgineer/Armory/SM_MKG_RawAetheriumShard_A01/`
- Unreal: `/Game/Aerathea/Props/Mekgineer/Armory/SM_MKG_RawAetheriumShard_A01`
