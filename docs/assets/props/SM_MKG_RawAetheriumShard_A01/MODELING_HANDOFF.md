# SM_MKG_RawAetheriumShard_A01 Modeling Handoff

## Purpose

Create the production DCC source and game-ready asset for `Gnome Armory.png#Core_RawShard` from the Gnome/Mekgineer armory catalog.

## Source References

- Production package: `docs/assets/props/SM_MKG_RawAetheriumShard_A01/PRODUCTION_PACKAGE.md`
...
Static Mesh raw material prop with this primary read: cluster of large angular blue shards with a simple dark base or no base, readable as raw resource not finished machinery.

## Modeling Constraints

- 18-35 cm tall; bottom-center pivot for world placement.
...
- Object/collection name: `SM_MKG_RawAetheriumShard_A01`.
...
- Blender source: `SourceAssets/Blender/Kits/Mekgineer/Armory/SM_MKG_RawAetheriumShard_A01/SM_MKG_RawAetheriumShard_A01.blend`
- FBX export: `SourceAssets/Exports/Kits/Mekgineer/Armory/SM_MKG_RawAetheriumShard_A01/SM_MKG_RawAetheriumShard_A01.fbx`
