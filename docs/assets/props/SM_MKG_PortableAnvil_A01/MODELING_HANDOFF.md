# SM_MKG_PortableAnvil_A01 Modeling Handoff

## Purpose

Create the production DCC source and game-ready asset for `Gnome Armory.png#Tools_PortableAnvil` from the Gnome/Mekgineer armory catalog.

## Source References

- Production package: `docs/assets/props/SM_MKG_PortableAnvil_A01/PRODUCTION_PACKAGE.md`
...
Static Mesh tool/prop with this primary read: small square case base with compact anvil top, side latches, and brass corner protectors.

## Modeling Constraints

- 30-45 cm wide, 25-38 cm tall; bottom-center pivot.
...
- Object/collection name: `SM_MKG_PortableAnvil_A01`.
...
- Blender source: `SourceAssets/Blender/Kits/Mekgineer/Armory/SM_MKG_PortableAnvil_A01/SM_MKG_PortableAnvil_A01.blend`
- FBX export: `SourceAssets/Exports/Kits/Mekgineer/Armory/SM_MKG_PortableAnvil_A01/SM_MKG_PortableAnvil_A01.fbx`
