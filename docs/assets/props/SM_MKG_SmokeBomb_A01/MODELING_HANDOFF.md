# SM_MKG_SmokeBomb_A01 Modeling Handoff

## Purpose

Create the production DCC source and game-ready asset for `Gnome Armory.png#Grenades_SmokeBomb` from the Gnome/Mekgineer armory catalog.

## Source References

- Production package: `docs/assets/props/SM_MKG_SmokeBomb_A01/PRODUCTION_PACKAGE.md`
...
Static Mesh throwable with this primary read: short cylindrical canister with capped ends, simple vent bands, and tiny blue status pip.

## Modeling Constraints

- 18-26 cm tall; pivot centered.
...
- Object/collection name: `SM_MKG_SmokeBomb_A01`.
...
- Blender source: `SourceAssets/Blender/Kits/Mekgineer/Armory/SM_MKG_SmokeBomb_A01/SM_MKG_SmokeBomb_A01.blend`
- FBX export: `SourceAssets/Exports/Kits/Mekgineer/Armory/SM_MKG_SmokeBomb_A01/SM_MKG_SmokeBomb_A01.fbx`
