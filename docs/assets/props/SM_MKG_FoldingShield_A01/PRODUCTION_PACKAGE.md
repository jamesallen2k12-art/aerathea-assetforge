# SM_MKG_FoldingShield_A01 Production Package

## Art Direction Summary

- Asset name: `SM_MKG_FoldingShield_A01`
- Asset type: Static Mesh shield/device
- Source: `Gnome Armory.png#Gear_FoldingShield`
...
Supports compact defensive device for gnome offhand and armory display. It can also serve future loot, crafting, vendor preview, armory display, equipment socket, and startup-scene review workflows where appropriate.

## Silhouette Notes

Primary read: rounded kite/oval shield folded into plated segments around a central Aetherium lens. Preserve the large readable forms first; any tiny screws, rivets, wire runs, gauge ticks, and surface scratches must be texture or normal-map detail.

## Scale Notes

55-75 cm tall; pivot on inner grip/forearm mount. Author in centimeters. Keep handles, grips, buttons, and attachment zones usable by compact 3-4 ft gnomes rather than human-scale proportions.
...
Create an original stylized fantasy MMORPG concept image of `SM_MKG_FoldingShield_A01`, a static mesh shield/device for the world of Aerathea. The design should emphasize rounded kite/oval shield folded into plated segments around a central Aetherium lens, compact gnome-scale ergonomics, brass and dark-iron engineering, dark leather utility details, restrained blue Aetherium accents, curious Mekgineer culture, and compact defensive device for gnome offhand and armory display. Use hand-painted texture detail, readable shapes, baked-AO-style depth, normal-map-style surface detail, sparing emissive accents, and MMO-friendly production design. Present it as a production asset sheet with front, side, three-quarter view, scale callout, and material callouts on a clean background. Avoid copying any existing franchise and avoid excessive micro-detail that would not translate to a mid-poly Unreal asset.
...
- `T_MKG_FoldingShield_A01_BC`
- `T_MKG_FoldingShield_A01_N`
- `T_MKG_FoldingShield_A01_ORM`
- `T_MKG_FoldingShield_A01_E` only for the explicit blue Aetherium lens/core/window
...
Static baseline. If gameplay needs deployment, create folded/unfolded mesh variants or a small Blueprint state later.

## Unreal Import Notes

- Unreal path: `/Game/Aerathea/Props/Mekgineer/Armory/SM_MKG_FoldingShield_A01`
...
- Docs: `docs/assets/props/SM_MKG_FoldingShield_A01/`
- Source: `SourceAssets/Blender/Kits/Mekgineer/Armory/SM_MKG_FoldingShield_A01/`
- Export: `SourceAssets/Exports/Kits/Mekgineer/Armory/SM_MKG_FoldingShield_A01/`
- Unreal: `/Game/Aerathea/Props/Mekgineer/Armory/SM_MKG_FoldingShield_A01`
