# SM_MKG_FoldingShield_A01 Modeling Handoff

## Purpose

Create the production DCC source and game-ready asset for `Gnome Armory.png#Gear_FoldingShield` from the Gnome/Mekgineer armory catalog.

## Source References

- Production package: `docs/assets/props/SM_MKG_FoldingShield_A01/PRODUCTION_PACKAGE.md`
...
Static Mesh shield/device with this primary read: rounded kite/oval shield folded into plated segments around a central Aetherium lens.

## Modeling Constraints

- 55-75 cm tall; pivot on inner grip/forearm mount.
...
- Object/collection name: `SM_MKG_FoldingShield_A01`.
...
- Blender source: `SourceAssets/Blender/Kits/Mekgineer/Armory/SM_MKG_FoldingShield_A01/SM_MKG_FoldingShield_A01.blend`
- FBX export: `SourceAssets/Exports/Kits/Mekgineer/Armory/SM_MKG_FoldingShield_A01/SM_MKG_FoldingShield_A01.fbx`
