# SM_MKG_RivetSparker_A01 Modeling Handoff

## Purpose

Create the production DCC source and game-ready asset for `Gnome Armory.png#Pistols_RivetSparker` from the Gnome/Mekgineer armory catalog.

## Source References

- Production package: `docs/assets/props/SM_MKG_RivetSparker_A01/PRODUCTION_PACKAGE.md`
...
Static Mesh pistol with this primary read: thick short barrel, round pressure chamber, stubby grip, and a blue ignition lens.

## Modeling Constraints

- 30-42 cm long; pivot at grip center.
...
- Object/collection name: `SM_MKG_RivetSparker_A01`.
...
- Blender source: `SourceAssets/Blender/Kits/Mekgineer/Armory/SM_MKG_RivetSparker_A01/SM_MKG_RivetSparker_A01.blend`
- FBX export: `SourceAssets/Exports/Kits/Mekgineer/Armory/SM_MKG_RivetSparker_A01/SM_MKG_RivetSparker_A01.fbx`
