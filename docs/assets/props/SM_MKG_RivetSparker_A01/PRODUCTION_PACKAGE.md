# SM_MKG_RivetSparker_A01 Production Package

## Art Direction Summary

- Asset name: `SM_MKG_RivetSparker_A01`
- Asset type: Static Mesh pistol
- Source: `Gnome Armory.png#Pistols_RivetSparker`
...
Supports industrial short-range pistol with rivet-gun silhouette for gnome weapon identity. It can also serve future loot, crafting, vendor preview, armory display, equipment socket, and startup-scene review workflows where appropriate.

## Silhouette Notes

Primary read: thick short barrel, round pressure chamber, stubby grip, and a blue ignition lens. Preserve the large readable forms first; any tiny screws, rivets, wire runs, gauge ticks, and surface scratches must be texture or normal-map detail.

## Scale Notes

30-42 cm long; pivot at grip center. Author in centimeters. Keep handles, grips, buttons, and attachment zones usable by compact 3-4 ft gnomes rather than human-scale proportions.
...
Create an original stylized fantasy MMORPG concept image of `SM_MKG_RivetSparker_A01`, a static mesh pistol for the world of Aerathea. The design should emphasize thick short barrel, round pressure chamber, stubby grip, and a blue ignition lens, compact gnome-scale ergonomics, brass and dark-iron engineering, dark leather utility details, restrained blue Aetherium accents, curious Mekgineer culture, and industrial short-range pistol with rivet-gun silhouette for gnome weapon identity. Use hand-painted texture detail, readable shapes, baked-AO-style depth, normal-map-style surface detail, sparing emissive accents, and MMO-friendly production design. Present it as a production asset sheet with front, side, three-quarter view, scale callout, and material callouts on a clean background. Avoid copying any existing franchise and avoid excessive micro-detail that would not translate to a mid-poly Unreal asset.
...
- `T_MKG_RivetSparker_A01_BC`
- `T_MKG_RivetSparker_A01_N`
- `T_MKG_RivetSparker_A01_ORM`
- `T_MKG_RivetSparker_A01_E` only for the explicit blue Aetherium lens/core/window
...
- Unreal path: `/Game/Aerathea/Props/Mekgineer/Armory/SM_MKG_RivetSparker_A01`
...
- Docs: `docs/assets/props/SM_MKG_RivetSparker_A01/`
- Source: `SourceAssets/Blender/Kits/Mekgineer/Armory/SM_MKG_RivetSparker_A01/`
- Export: `SourceAssets/Exports/Kits/Mekgineer/Armory/SM_MKG_RivetSparker_A01/`
- Unreal: `/Game/Aerathea/Props/Mekgineer/Armory/SM_MKG_RivetSparker_A01`
