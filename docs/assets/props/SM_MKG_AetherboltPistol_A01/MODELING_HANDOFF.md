# SM_MKG_AetherboltPistol_A01 Modeling Handoff

## Purpose

Create the production DCC source and game-ready asset for `Gnome Armory.png#Pistols_AetherboltPistol` from the Gnome/Mekgineer armory catalog.

## Source References

- Production package: `docs/assets/props/SM_MKG_AetherboltPistol_A01/PRODUCTION_PACKAGE.md`
...
Static Mesh pistol with this primary read: compact pistol body with oversized blue muzzle crystal, dark-iron barrel shroud, and brass grip frame.

## Modeling Constraints

- 32-45 cm long; muzzle socket required.
...
- Object/collection name: `SM_MKG_AetherboltPistol_A01`.
...
- Blender source: `SourceAssets/Blender/Kits/Mekgineer/Armory/SM_MKG_AetherboltPistol_A01/SM_MKG_AetherboltPistol_A01.blend`
- FBX export: `SourceAssets/Exports/Kits/Mekgineer/Armory/SM_MKG_AetherboltPistol_A01/SM_MKG_AetherboltPistol_A01.fbx`
