# SM_MKG_StickyBomb_A01 Modeling Handoff

## Purpose

Create the production DCC source and game-ready asset for `Gnome Armory.png#Grenades_StickyBomb` from the Gnome/Mekgineer armory catalog.

## Source References

- Production package: `docs/assets/props/SM_MKG_StickyBomb_A01/PRODUCTION_PACKAGE.md`
...
Static Mesh throwable with this primary read: ribbed cylinder with broad clamp bands and one top arming cap.

## Modeling Constraints

- 18-28 cm tall; attach preview socket at rear face.
...
- Object/collection name: `SM_MKG_StickyBomb_A01`.
...
- Blender source: `SourceAssets/Blender/Kits/Mekgineer/Armory/SM_MKG_StickyBomb_A01/SM_MKG_StickyBomb_A01.blend`
- FBX export: `SourceAssets/Exports/Kits/Mekgineer/Armory/SM_MKG_StickyBomb_A01/SM_MKG_StickyBomb_A01.fbx`
