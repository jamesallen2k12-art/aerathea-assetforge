# KIT_GNM_ForgeguardPlate_A01 Production Package

## Art Direction Summary

- Asset name: `KIT_GNM_ForgeguardPlate_A01`
- Asset type: Gear configuration kit
- Source: `Gnome Armory.png#Config_ForgeguardPlate`
...
Supports heavier defensive gnome armor configuration for workshop guards and elite engineers. It can also serve future loot, crafting, vendor preview, armory display, equipment socket, and startup-scene review workflows where appropriate.

## Silhouette Notes

Primary read: broad helmet, heavier shoulder plates, thick chest armor, reinforced gauntlets, large boots, and restrained blue core. Preserve the large readable forms first; any tiny screws, rivets, wire runs, gauge ticks, and surface scratches must be texture or normal-map detail.

## Scale Notes

assembled over `SK_GNM_Base_A01`; do not make the gnome human-scale. Author in centimeters. Keep handles, grips, buttons, and attachment zones usable by compact 3-4 ft gnomes rather than human-scale proportions.
...
Create an original stylized fantasy MMORPG concept image of `KIT_GNM_ForgeguardPlate_A01`, a gear configuration kit for the world of Aerathea. The design should emphasize broad helmet, heavier shoulder plates, thick chest armor, reinforced gauntlets, large boots, and restrained blue core, compact gnome-scale ergonomics, brass and dark-iron engineering, dark leather utility details, restrained blue Aetherium accents, curious Mekgineer culture, and heavier defensive gnome armor configuration for workshop guards and elite engineers. Use hand-painted texture detail, readable shapes, baked-AO-style depth, normal-map-style surface detail, sparing emissive accents, and MMO-friendly production design. Present it as a production asset sheet with front, side, three-quarter view, scale callout, and material callouts on a clean background. Avoid copying any existing franchise and avoid excessive micro-detail that would not translate to a mid-poly Unreal asset.
...
- `T_GNM_ForgeguardPlate_A01_BC`
- `T_GNM_ForgeguardPlate_A01_N`
- `T_GNM_ForgeguardPlate_A01_ORM`
- `T_GNM_ForgeguardPlate_A01_E` only for the explicit blue Aetherium lens/core/window
- Prefer one material slot; use two only when a backpack, rifle, shield, or configuration needs a shared core material split.

## Triangle Budget

LOD0 22k-30k tris over base body if previewed as a full outfit.
...
- Unreal path: `/Game/Aerathea/Characters/Gnomes/Gear/Kits/KIT_GNM_ForgeguardPlate_A01`
...
- Docs: `docs/assets/kits/KIT_GNM_ForgeguardPlate_A01/`
- Source: `SourceAssets/Blender/Characters/Gnomes/Gear/Kits/KIT_GNM_ForgeguardPlate_A01/`
- Export: `SourceAssets/Exports/Characters/Gnomes/Gear/Kits/KIT_GNM_ForgeguardPlate_A01/`
- Unreal: `/Game/Aerathea/Characters/Gnomes/Gear/Kits/KIT_GNM_ForgeguardPlate_A01`
