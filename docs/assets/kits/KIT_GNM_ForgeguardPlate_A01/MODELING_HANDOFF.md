# KIT_GNM_ForgeguardPlate_A01 Modeling Handoff

## Purpose

Create the production DCC source and game-ready asset for `Gnome Armory.png#Config_ForgeguardPlate` from the Gnome/Mekgineer armory catalog.

## Source References

- Production package: `docs/assets/kits/KIT_GNM_ForgeguardPlate_A01/PRODUCTION_PACKAGE.md`
...
Gear configuration kit with this primary read: broad helmet, heavier shoulder plates, thick chest armor, reinforced gauntlets, large boots, and restrained blue core.

## Modeling Constraints

- assembled over `SK_GNM_Base_A01`; do not make the gnome human-scale.
...
- Object/collection name: `KIT_GNM_ForgeguardPlate_A01`.
...
- Blender source: `SourceAssets/Blender/Characters/Gnomes/Gear/Kits/KIT_GNM_ForgeguardPlate_A01/KIT_GNM_ForgeguardPlate_A01.blend`
- FBX export: `SourceAssets/Exports/Characters/Gnomes/Gear/Kits/KIT_GNM_ForgeguardPlate_A01/KIT_GNM_ForgeguardPlate_A01.fbx`
