# KIT_GNM_TinkersGear_A01 Modeling Handoff

## Purpose

Create the production DCC source and game-ready asset for `Gnome Armory.png#Config_TinkersGear` from the Gnome/Mekgineer armory catalog.

## Source References

- Production package: `docs/assets/kits/KIT_GNM_TinkersGear_A01/PRODUCTION_PACKAGE.md`
...
Gear configuration kit with this primary read: slim chest rig, small shoulder plates, tool belt, compact backpack, oversized boots, and visible goggles.

## Modeling Constraints

- assembled over `SK_GNM_Base_A01`; 110-120 cm target height.
...
- Object/collection name: `KIT_GNM_TinkersGear_A01`.
...
- Blender source: `SourceAssets/Blender/Characters/Gnomes/Gear/Kits/KIT_GNM_TinkersGear_A01/KIT_GNM_TinkersGear_A01.blend`
- FBX export: `SourceAssets/Exports/Characters/Gnomes/Gear/Kits/KIT_GNM_TinkersGear_A01/KIT_GNM_TinkersGear_A01.fbx`
