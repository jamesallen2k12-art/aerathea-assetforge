# KIT_ORC_Arsenal_A01 Child Asset Intake

## Source

- Source concept: `/home/Flamestrike/Desktop/Aerathea/Aerathea Creative/ASSET CONCEPTS/Orc Arsenal.png`
- Faction/theme: Orc
...
The sheet is a catalog for honorable Orc warden/seeress gear. Several weapon rows are grouped rather than individually labeled, so stable numbered child IDs are used until Flamestrike names individual pieces.
...
| `Orc Arsenal.png#HeavyBlade_01` | Heavy blade | `SM_ORC_HeavyBlade_A01` | Package needed | Straight heavy sword |
| `Orc Arsenal.png#HeavyBlade_02` | Heavy blade | `SM_ORC_HeavyBlade_A02` | Package needed | Wide guarded blade |
| `Orc Arsenal.png#HeavyBlade_03` | Heavy blade | `SM_ORC_HeavyBlade_A03` | Package needed | Curved heavy blade |
| `Orc Arsenal.png#HeavyBlade_04` | Heavy blade | `SM_ORC_HeavyBlade_A04` | Package needed | Rune-channel blade |
| `Orc Arsenal.png#HeavyBlade_05` | Heavy blade | `SM_ORC_HeavyBlade_A05` | Package needed | Hooked heavy blade |
| `Orc Arsenal.png#Polearm_Set` | Spears/polearms | `KIT_ORC_Polearms_A01` | Package needed | Seven visible polearm variants |
| `Orc Arsenal.png#Bow_Set` | Hunting bows | `KIT_ORC_HuntingBows_A01` | Package needed | Three bow variants |
| `Orc Arsenal.png#ThrowingWeapons_Set` | Throwing weapons | `KIT_ORC_ThrowingWeapons_A01` | Package needed | Axe, knives, darts/quiver group |
...
3. `KIT_ORC_ShamanicTalismans_A01`
4. `MI_ORC_RunicAffinities_A01`
