...
- LOD setup: import the visual-only `*_UnrealImport.fbx` as the base mesh, then assign `_LOD1.fbx`, `_LOD2.fbx`, and `_LOD3.fbx`.
...
Execution note, 2026-07-03: initial testing found the main FBX UCX proxies imported as renderable sections and extra material slots. The completed import therefore used visual-only `*_UnrealImport.fbx` files and generated broad simple Unreal collision by script.
...
| --- | --- | --- | --- |
| `SM_GIA_BloodAxeApproachCairnMarker_A01` | `SourceAssets/Exports/Props/Giants/BloodAxe/StrongholdApproach/CairnMarkers/SM_GIA_BloodAxeApproachCairnMarker_A01/SM_GIA_BloodAxeApproachCairnMarker_A01_UnrealImport.fbx` | `/Game/Aerathea/Props/Giants/BloodAxe/StrongholdApproach/CairnMarkers/SM_GIA_BloodAxeApproachCairnMarker_A01` | broad simple fallback |
| `SM_GIA_BloodAxeRitualCairnGuidepost_A01` | `SourceAssets/Exports/Props/Giants/BloodAxe/RitualStones/Guideposts/SM_GIA_BloodAxeRitualCairnGuidepost_A01/SM_GIA_BloodAxeRitualCairnGuidepost_A01_UnrealImport.fbx` | `/Game/Aerathea/Props/Giants/BloodAxe/RitualStones/Guideposts/SM_GIA_BloodAxeRitualCairnGuidepost_A01` | broad simple fallback |
| `SM_GIA_BloodAxeLowThresholdCairn_A01` | `SourceAssets/Exports/Props/Giants/BloodAxe/CaveApproachMarkers/SM_GIA_BloodAxeLowThresholdCairn_A01/SM_GIA_BloodAxeLowThresholdCairn_A01_UnrealImport.fbx` | `/Game/Aerathea/Props/Giants/BloodAxe/CaveApproachMarkers/SM_GIA_BloodAxeLowThresholdCairn_A01` | broad simple fallback |
| `SM_GIA_BloodAxeCollapsedThresholdCairn_A01` | `SourceAssets/Exports/Props/Giants/BloodAxe/CaveApproachMarkers/SM_GIA_BloodAxeCollapsedThresholdCairn_A01/SM_GIA_BloodAxeCollapsedThresholdCairn_A01_UnrealImport.fbx` | `/Game/Aerathea/Props/Giants/BloodAxe/CaveApproachMarkers/SM_GIA_BloodAxeCollapsedThresholdCairn_A01` | broad simple fallback |
| `SM_GIA_BloodAxeCaveRemnantCairn_A01` | `SourceAssets/Exports/Props/Giants/BloodAxe/CaveApproachMarkers/SM_GIA_BloodAxeCaveRemnantCairn_A01/SM_GIA_BloodAxeCaveRemnantCairn_A01_UnrealImport.fbx` | `/Game/Aerathea/Props/Giants/BloodAxe/CaveApproachMarkers/SM_GIA_BloodAxeCaveRemnantCairn_A01` | broad simple fallback |
| `SM_GIA_BloodAxeCollapsedCaveRemnantCairn_A01` | `SourceAssets/Exports/Props/Giants/BloodAxe/CaveApproachMarkers/SM_GIA_BloodAxeCollapsedCaveRemnantCairn_A01/SM_GIA_BloodAxeCollapsedCaveRemnantCairn_A01_UnrealImport.fbx` | `/Game/Aerathea/Props/Giants/BloodAxe/CaveApproachMarkers/SM_GIA_BloodAxeCollapsedCaveRemnantCairn_A01` | broad simple fallback |
| `SM_GIA_BloodAxeCaveThresholdCairnPair_A01` | `SourceAssets/Exports/Props/Giants/BloodAxe/CaveApproachMarkers/SM_GIA_BloodAxeCaveThresholdCairnPair_A01/SM_GIA_BloodAxeCaveThresholdCairnPair_A01_UnrealImport.fbx` | `/Game/Aerathea/Props/Giants/BloodAxe/CaveApproachMarkers/SM_GIA_BloodAxeCaveThresholdCairnPair_A01` | broad simple fallback |
| `SM_GIA_BloodAxeMovedCampCairnPair_A01` | `SourceAssets/Exports/Props/Giants/BloodAxe/MovedCamp/SM_GIA_BloodAxeMovedCampCairnPair_A01/SM_GIA_BloodAxeMovedCampCairnPair_A01_UnrealImport.fbx` | `/Game/Aerathea/Props/Giants/BloodAxe/MovedCamp/SM_GIA_BloodAxeMovedCampCairnPair_A01` | broad simple fallback |
| `SM_GIA_BloodAxePairedCairnClosePair_A01` | `SourceAssets/Exports/Props/Giants/BloodAxe/CairnGuideposts/SM_GIA_BloodAxePairedCairnClosePair_A01/SM_GIA_BloodAxePairedCairnClosePair_A01_UnrealImport.fbx` | `/Game/Aerathea/Props/Giants/BloodAxe/CairnGuideposts/SM_GIA_BloodAxePairedCairnClosePair_A01` | broad simple fallback |
| `SM_GIA_BloodAxePairedCairnStaggeredPair_A01` | `SourceAssets/Exports/Props/Giants/BloodAxe/CairnGuideposts/SM_GIA_BloodAxePairedCairnStaggeredPair_A01/SM_GIA_BloodAxePairedCairnStaggeredPair_A01_UnrealImport.fbx` | `/Game/Aerathea/Props/Giants/BloodAxe/CairnGuideposts/SM_GIA_BloodAxePairedCairnStaggeredPair_A01` | broad simple fallback |
| `SM_GIA_BloodAxeCairnPathMarker_A01` | `SourceAssets/Exports/Props/Giants/BloodAxe/PathMarkers/SM_GIA_BloodAxeCairnPathMarker_A01/SM_GIA_BloodAxeCairnPathMarker_A01_UnrealImport.fbx` | `/Game/Aerathea/Props/Giants/BloodAxe/PathMarkers/SM_GIA_BloodAxeCairnPathMarker_A01` | broad simple fallback |
| `SM_GIA_BloodAxeCairnScrapCap_A01` | `SourceAssets/Exports/Props/Giants/BloodAxe/PathMarkers/SM_GIA_BloodAxeCairnScrapCap_A01/SM_GIA_BloodAxeCairnScrapCap_A01_UnrealImport.fbx` | `/Game/Aerathea/Props/Giants/BloodAxe/PathMarkers/SM_GIA_BloodAxeCairnScrapCap_A01` | broad simple fallback |
