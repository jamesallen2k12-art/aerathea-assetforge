# SK_GNM_Greaves_MKG_A01 Modeling Handoff

## Purpose

Create the production DCC source and game-ready asset for `Gnome Armory.png#Armor_Greaves` from the Gnome/Mekgineer armory catalog.

## Source References

- Production package: `docs/assets/characters/SK_GNM_Greaves_MKG_A01/PRODUCTION_PACKAGE.md`
...
Skeletal/attachable armor module with this primary read: large boot-forward greaves with broad shin plates, dark-iron toe caps, and leather straps.

## Modeling Constraints

- fits `SK_GNM_Base_A01`; boot ground contact must stay stable.
...
- Object/collection name: `SK_GNM_Greaves_MKG_A01`.
...
- Blender source: `SourceAssets/Blender/Characters/Gnomes/Gear/SK_GNM_Greaves_MKG_A01/SK_GNM_Greaves_MKG_A01.blend`
- FBX export: `SourceAssets/Exports/Characters/Gnomes/Gear/SK_GNM_Greaves_MKG_A01/SK_GNM_Greaves_MKG_A01.fbx`
