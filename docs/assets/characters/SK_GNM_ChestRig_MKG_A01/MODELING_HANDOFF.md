# SK_GNM_ChestRig_MKG_A01 Modeling Handoff

## Purpose

Create the production DCC source and game-ready asset for `Gnome Armory.png#Armor_ChestRig` from the Gnome/Mekgineer armory catalog.

## Source References

- Production package: `docs/assets/characters/SK_GNM_ChestRig_MKG_A01/PRODUCTION_PACKAGE.md`
...
Skeletal/attachable armor module with this primary read: compact rectangular chest harness with large central blue core socket, belt straps, and side pouches.

## Modeling Constraints

- fits `SK_GNM_Base_A01`; chest, belt, and back sockets required.
...
- Object/collection name: `SK_GNM_ChestRig_MKG_A01`.
...
- Blender source: `SourceAssets/Blender/Characters/Gnomes/Gear/SK_GNM_ChestRig_MKG_A01/SK_GNM_ChestRig_MKG_A01.blend`
- FBX export: `SourceAssets/Exports/Characters/Gnomes/Gear/SK_GNM_ChestRig_MKG_A01/SK_GNM_ChestRig_MKG_A01.fbx`
