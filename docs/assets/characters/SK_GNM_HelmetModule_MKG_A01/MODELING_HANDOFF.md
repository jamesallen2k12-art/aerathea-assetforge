# SK_GNM_HelmetModule_MKG_A01 Modeling Handoff

## Purpose

Create the production DCC source and game-ready asset for `Gnome Armory.png#Armor_HelmetModule` from the Gnome/Mekgineer armory catalog.

## Source References

- Production package: `docs/assets/characters/SK_GNM_HelmetModule_MKG_A01/PRODUCTION_PACKAGE.md`
...
Skeletal/attachable armor module with this primary read: domed helmet with ear clearance, brass rim, dark-iron side plates, and optional blue brow lens.

## Modeling Constraints

- fits `SK_GNM_Base_A01`; final sizing blocked on approved head/ear proportions.
...
- Object/collection name: `SK_GNM_HelmetModule_MKG_A01`.
...
- Blender source: `SourceAssets/Blender/Characters/Gnomes/Gear/SK_GNM_HelmetModule_MKG_A01/SK_GNM_HelmetModule_MKG_A01.blend`
- FBX export: `SourceAssets/Exports/Characters/Gnomes/Gear/SK_GNM_HelmetModule_MKG_A01/SK_GNM_HelmetModule_MKG_A01.fbx`
