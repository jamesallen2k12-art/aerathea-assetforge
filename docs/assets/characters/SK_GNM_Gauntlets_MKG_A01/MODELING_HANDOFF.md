# SK_GNM_Gauntlets_MKG_A01 Modeling Handoff

## Purpose

Create the production DCC source and game-ready asset for `Gnome Armory.png#Armor_Gauntlets` from the Gnome/Mekgineer armory catalog.

## Source References

- Production package: `docs/assets/characters/SK_GNM_Gauntlets_MKG_A01/PRODUCTION_PACKAGE.md`
...
Skeletal/attachable armor module with this primary read: oversized work gloves with plated knuckle forms, thick wrist cuffs, and simple brass caps.

## Modeling Constraints

- fits `SK_GNM_Base_A01`; must match approved gnome hand rig.
...
- Object/collection name: `SK_GNM_Gauntlets_MKG_A01`.
...
- Blender source: `SourceAssets/Blender/Characters/Gnomes/Gear/SK_GNM_Gauntlets_MKG_A01/SK_GNM_Gauntlets_MKG_A01.blend`
- FBX export: `SourceAssets/Exports/Characters/Gnomes/Gear/SK_GNM_Gauntlets_MKG_A01/SK_GNM_Gauntlets_MKG_A01.fbx`
