# SK_GNM_MekHarness_MKG_A01 Production Package

## Art Direction Summary

- Asset name: `SK_GNM_MekHarness_MKG_A01`
- Asset type: Skeletal/attachable harness/backpack
- Source: `Gnome Armory.png#Backpack_MekHarness`
...
Supports character-to-Mek interface harness for future Mek suit or companion attachment rules. It can also serve future loot, crafting, vendor preview, armory display, equipment socket, and startup-scene review workflows where appropriate.

## Silhouette Notes

Primary read: broad back frame with shoulder straps, lower belt clamps, central blue link plate, and two side hardpoints. Preserve the large readable forms first; any tiny screws, rivets, wire runs, gauge ticks, and surface scratches must be texture or normal-map detail.

## Scale Notes

fits `SK_GNM_Base_A01`; hardpoint sockets required. Author in centimeters. Keep handles, grips, buttons, and attachment zones usable by compact 3-4 ft gnomes rather than human-scale proportions.
...
Create an original stylized fantasy MMORPG concept image of `SK_GNM_MekHarness_MKG_A01`, a skeletal/attachable harness/backpack for the world of Aerathea. The design should emphasize broad back frame with shoulder straps, lower belt clamps, central blue link plate, and two side hardpoints, compact gnome-scale ergonomics, brass and dark-iron engineering, dark leather utility details, restrained blue Aetherium accents, curious Mekgineer culture, and character-to-Mek interface harness for future Mek suit or companion attachment rules. Use hand-painted texture detail, readable shapes, baked-AO-style depth, normal-map-style surface detail, sparing emissive accents, and MMO-friendly production design. Present it as a production asset sheet with front, side, three-quarter view, scale callout, and material callouts on a clean background. Avoid copying any existing franchise and avoid excessive micro-detail that would not translate to a mid-poly Unreal asset.
...
- `T_GNM_MekHarness_MKG_A01_BC`
- `T_GNM_MekHarness_MKG_A01_N`
- `T_GNM_MekHarness_MKG_A01_ORM`
- `T_GNM_MekHarness_MKG_A01_E` only for the explicit blue Aetherium lens/core/window
- Prefer one material slot; use two only when a backpack, rifle, shield, or configuration needs a shared core material split.

## Triangle Budget

LOD0 4k-8k tris, 1-2 material slots.
...
- Unreal path: `/Game/Aerathea/Characters/Gnomes/Gear/SK_GNM_MekHarness_MKG_A01`
...
- Docs: `docs/assets/characters/SK_GNM_MekHarness_MKG_A01/`
- Source: `SourceAssets/Blender/Characters/Gnomes/Gear/SK_GNM_MekHarness_MKG_A01/`
- Export: `SourceAssets/Exports/Characters/Gnomes/Gear/SK_GNM_MekHarness_MKG_A01/`
- Unreal: `/Game/Aerathea/Characters/Gnomes/Gear/SK_GNM_MekHarness_MKG_A01`
