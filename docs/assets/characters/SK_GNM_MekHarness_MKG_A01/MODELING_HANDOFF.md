# SK_GNM_MekHarness_MKG_A01 Modeling Handoff

## Purpose

Create the production DCC source and game-ready asset for `Gnome Armory.png#Backpack_MekHarness` from the Gnome/Mekgineer armory catalog.

## Source References

- Production package: `docs/assets/characters/SK_GNM_MekHarness_MKG_A01/PRODUCTION_PACKAGE.md`
...
Skeletal/attachable harness/backpack with this primary read: broad back frame with shoulder straps, lower belt clamps, central blue link plate, and two side hardpoints.

## Modeling Constraints

- fits `SK_GNM_Base_A01`; hardpoint sockets required.
...
- Object/collection name: `SK_GNM_MekHarness_MKG_A01`.
...
- Blender source: `SourceAssets/Blender/Characters/Gnomes/Gear/SK_GNM_MekHarness_MKG_A01/SK_GNM_MekHarness_MKG_A01.blend`
- FBX export: `SourceAssets/Exports/Characters/Gnomes/Gear/SK_GNM_MekHarness_MKG_A01/SK_GNM_MekHarness_MKG_A01.fbx`
