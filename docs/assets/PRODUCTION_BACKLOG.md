...
| `KIT_GNM_OGR_RivalryEncounter_A01` | Source intake and production package ready for 21 Gnome-vs-Ogre encounter images plus 4 added heavy Mek variants; first-pass Unreal implementation now includes shieldwall Blueprint/VFX contract polish, Ogre Teknomancer, Heavy Mek, Ogre Warrior, Ogre cairn gate, crude Tek pylon, base/interrupt Manticore, Ogre Shaman, Ogre Necromancer, and native encounter coordinator | Assign imported optional branch assets to `BP_GNM_OGR_BattlefieldEncounter_A01`, then validate encounter phase sequencing |
...
| `SM_OGR_CrudeTekPylon_A01` | First-pass Blender source/FBX generated, imported to Unreal, material instances assigned, LOD0-LOD3 generated, static mesh sockets added, startup review actor placed, validation passing | Build optional `BP_OGR_CrudeTekPylon_A01` state wrapper after final encounter phase needs are clear |
...
3. Assign `SM_OGR_CrudeTekPylon_A01`, `SK_OGR_Shaman_A01`, `SK_OGR_Necromancer_A01`, `SK_CRE_Manticore_A01`, and `SK_CRE_Manticore_Interrupt_A01` into `BP_GNM_OGR_BattlefieldEncounter_A01`, then validate coordinator phase sequencing.
