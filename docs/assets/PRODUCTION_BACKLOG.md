...
| `KIT_GNM_OGR_RivalryEncounter_A01` | Source intake and production package ready for 21 Gnome-vs-Ogre encounter images plus 4 added heavy Mek variants; approved sequence is complete through shieldwall Blueprint/VFX contract polish, Ogre Teknomancer, Heavy Mek, Ogre Warrior, Ogre cairn gate, and Manticore interrupt planning | Choose the next rivalry follow-up: final authored Niagara art, base `SK_CRE_Manticore_A01`, Ogre Shaman/Necromancer, crude Tek pylon, or encounter assembly Blueprint |
...
| `SK_CRE_Manticore_Interrupt_A01` | Encounter-variant production package, modeling handoff, and build/import status ready; source references visually inspected | Create and approve base `SK_CRE_Manticore_A01` direction, skeleton, and proportions before any DCC build |
...
| Manticore | Lion body, bat/draconic wings, scorpion tail, dangerous ruin/desert predator | `SK_CRE_Manticore_Interrupt_A01` planning package is ready for the Gnome/Ogre interrupt variant; create base `SK_CRE_Manticore_A01` direction, skeleton, and proportions before any DCC build |
...
3. Choose the next Gnome/Ogre rivalry follow-up now that the approved five-item sequence is complete.
