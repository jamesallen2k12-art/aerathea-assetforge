...
3. Continue the approved Gnome/Ogre rivalry sequence with Ogre Shaman/Necromancer class packages, crude Tek pylon, encounter assembly Blueprint, and final authored shieldwall Niagara art.
...
10. Continue Ogre final-art planning from the imported `SK_OGR_Base_A01`, `SK_OGR_Teknomancer_A01`, and `SK_OGR_Warrior_Rival_A01` review slices, then choose Shaman or Necromancer as the next class package.
