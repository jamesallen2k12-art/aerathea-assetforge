...
| `SM-GIA-BloodAxeCairnTarget-A1-A01-DCCProof` | DCC source candidate requested changes after concept-geometry and paint review; not canon | Blood Axe cairn target A1 static prop rebuild | Current in-progress trace proof: `docs/assets/props/SM_GIA_BloodAxeCairnTarget_A1_A01/SM_GIA_BloodAxeCairnTarget_A1_A01_TracedGeometryPass_A03.png`; rejected clean baseline retained at `docs/assets/props/SM_GIA_BloodAxeCairnTarget_A1_A01/SM_GIA_BloodAxeCairnTarget_A1_A01_RejectedCleanBaseline_A02.png` | Created from the clearer `BloodAxe A1` target set on 2026-07-03; latest user-reviewed image rejected by Flamestrike and retained as failure evidence; trace guide pass is saved for learning but not approved | Useful source lane with authored 360-degree massing, LODs, UCX, textures, and no-thickness red pigment; current improvement lowers the front slab and reduces lashing clutter, but failing points remain fractured-plane match, rear slab integration, rope contact, and paint embedding | Revision base only; do not treat as visual canon, do not expand to other A/B targets, and do not import to Unreal |
