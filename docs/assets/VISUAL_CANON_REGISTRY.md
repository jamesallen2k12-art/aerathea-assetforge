...
| `SM-GIA-BloodAxeCairnTarget-A1-A01-DCCProof` | DCC source candidate requested changes after concept-geometry and paint review; not canon | Blood Axe cairn target A1 static prop rebuild | Current rejected proof: `docs/assets/props/SM_GIA_BloodAxeCairnTarget_A1_A01/SM_GIA_BloodAxeCairnTarget_A1_A01_RejectedCleanBaseline_A02.png`; earlier comparison/material proofs remain in `docs/assets/props/SM_GIA_BloodAxeCairnTarget_A1_A01/` | Created from the clearer `BloodAxe A1` target set on 2026-07-03; latest review image rejected by Flamestrike and retained as failure evidence | Useful source lane with authored 360-degree massing, LODs, UCX, textures, and no-thickness red pigment; failing points are broad/wall-like front read, concept proportion mismatch, procedural stone breakup, and rope/paint placement drift | Revision base only; do not treat as visual canon, do not expand to other A/B targets, and do not import to Unreal |
