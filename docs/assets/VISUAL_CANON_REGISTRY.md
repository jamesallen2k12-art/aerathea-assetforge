...
| `SM-GIA-BloodAxeCairnTarget-A1-A01-DCCProof` | DCC source candidate pending concept-geometry review; not canon | Blood Axe cairn target A1 static prop rebuild | `docs/assets/props/SM_GIA_BloodAxeCairnTarget_A1_A01/SM_GIA_BloodAxeCairnTarget_A1_A01_ConceptGeometryCompare.png`; material proof: `docs/assets/props/SM_GIA_BloodAxeCairnTarget_A1_A01/SM_GIA_BloodAxeCairnTarget_A1_A01_MaterialTextureProof.png` | Created from the clearer `BloodAxe A1` target set on 2026-07-03; fourth geometry pass and first material/texture integration proof regenerated on 2026-07-03 | Establishes a clean A1 rebuild lane with dominant front slab, rear slab, left lashed stack, right supports, authored 360-degree massing, more fractured large-stone silhouettes, and first-pass 1K BC/N/ORM proof materials; still pending concept-geometry and material approval | Use as current DCC source proof and revision base only; not approved visual canon and not ready for Unreal import |
