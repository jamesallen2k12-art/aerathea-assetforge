...
| `SM-GIA-BloodAxeCairnTarget-A1-A01-DCCProof` | DCC source candidate pending concept-geometry and paint review; not canon | Blood Axe cairn target A1 static prop rebuild | `docs/assets/props/SM_GIA_BloodAxeCairnTarget_A1_A01/SM_GIA_BloodAxeCairnTarget_A1_A01_ConceptGeometryCompare.png`; strict paint proof: `docs/assets/props/SM_GIA_BloodAxeCairnTarget_A1_A01/SM_GIA_BloodAxeCairnTarget_A1_A01_StrictFrontPaintCompare.png`; material proof: `docs/assets/props/SM_GIA_BloodAxeCairnTarget_A1_A01/SM_GIA_BloodAxeCairnTarget_A1_A01_MaterialTextureProof.png` | Created from the clearer `BloodAxe A1` target set on 2026-07-03; fourth geometry pass, first material/texture proof, and strict no-thickness red paint correction proof regenerated on 2026-07-03 | Establishes a clean A1 rebuild lane with dominant front slab, rear slab, left lashed stack, right supports, authored 360-degree massing, fractured large-stone silhouettes, 1K BC/N/ORM proof materials, and red markings corrected from raised strip geometry to surface pigment; still pending approval | Use as current DCC source proof and revision base only; not approved visual canon and not ready for Unreal import |
